; ModuleID = '/nethome/asandeep6/FPGA_ECE8893/2026_Spring/lab0/project_1/hls/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: inaccessiblemem_or_argmemonly noinline willreturn
define void @apatb_top_kernel_ir(i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="100" "maxi" %a, i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="100" "maxi" %b, i32* noalias nocapture nonnull "fpga.decayed.dim.hint"="100" "maxi" %sum) local_unnamed_addr #0 {
entry:
  ...
  %2 = bitcast i32* %sum to [100 x i32]*
  %sum_copy = alloca [100 x i32], align 512
  call fastcc void @copy_in([100 x i32]* nonnull %0, [100 x i32]* nonnull align 512 %a_copy, [100 x i32]* nonnull %1, [100 x i32]* nonnull align 512 %b_copy, [100 x i32]* nonnull %2, [100 x i32]* nonnull align 512 %sum_copy)
  call void @apatb_top_kernel_hw([100 x i32]* %a_copy, [100 x i32]* %b_copy, [100 x i32]* %sum_copy)
  call void @copy_back([100 x i32]* %0, [100 x i32]* %a_copy, [100 x i32]* %1, [100 x i32]* %b_copy, [100 x i32]* %2, [100 x i32]* %sum_copy)
  ret void
}
...
declare void @apatb_top_kernel_hw([100 x i32]*, [100 x i32]*, [100 x i32]*)
...
declare void @top_kernel_hw_stub(i32* noalias nocapture nonnull readonly, i32* noalias nocapture nonnull readonly, i32* noalias nocapture nonnull)

define void @top_kernel_hw_stub_wrapper([100 x i32]*, [100 x i32]*, [100 x i32]*) #5 {
entry:
  ...
  call void @top_kernel_hw_stub(i32* %3, i32* %4, i32* %5)
