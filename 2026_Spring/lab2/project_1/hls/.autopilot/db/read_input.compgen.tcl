...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { inter_strm_0_din { O 24 vector } inter_strm_0_full_n { I 1 bit } inter_strm_0_write { O 1 bit } inter_strm_0_num_data_valid { I 10 vector } inter_strm_0_fifo_cap { I 10 vector } } \
} "
}
