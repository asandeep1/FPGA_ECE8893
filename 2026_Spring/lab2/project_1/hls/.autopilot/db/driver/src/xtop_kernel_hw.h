...
#define XTOP_KERNEL_CONTROL_ADDR_A_IN_DATA  0x10
#define XTOP_KERNEL_CONTROL_BITS_A_IN_DATA  64
#define XTOP_KERNEL_CONTROL_ADDR_A_OUT_DATA 0x1c
#define XTOP_KERNEL_CONTROL_BITS_A_OUT_DATA 64
