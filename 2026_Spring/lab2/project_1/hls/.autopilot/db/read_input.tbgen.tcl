...
set C_modelArgList {
	...
	{ in_r int 64 regular  }
	{ inter_strm_0 int 24 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "A_in","offset": { "type": "dynamic","port_name": "A_in","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "inter_strm_0", "interface" : "fifo", "bitwidth" : 24, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ inter_strm_0_din sc_out sc_lv 24 signal 2 } 
	{ inter_strm_0_full_n sc_in sc_logic 1 signal 2 } 
	{ inter_strm_0_write sc_out sc_logic 1 signal 2 } 
	{ inter_strm_0_num_data_valid sc_in sc_lv 10 signal 2 } 
	{ inter_strm_0_fifo_cap sc_in sc_lv 10 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "inter_strm_0_din", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "inter_strm_0", "role": "din" }} , 
 	{ "name": "inter_strm_0_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "inter_strm_0", "role": "full_n" }} , 
 	{ "name": "inter_strm_0_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "inter_strm_0", "role": "write" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "65547", "Max" : "65547"}
	, {"Name" : "Interval", "Min" : "65547", "Max" : "65547"}
]}
