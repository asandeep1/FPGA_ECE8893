...
void read_input(const data_t in[256][256], hls::stream<data_t>& strm) {
    VITIS_LOOP_125_1: for (int i = 0; i < 256 * 256; i++) {
...
#pragma HLS ARRAY_PARTITION variable=window complete
 ...
 const int total_iterations = 256 * 256 + 256 + 1;
    ...
    VITIS_LOOP_141_1: for (int k = 0; k < total_iterations; k++) {
#pragma HLS PIPELINE II=1
 ...
 data_t curr = 0;
        ...
        VITIS_LOOP_149_2: for(int r = 0; r < 3; r++) {
...
void write_output(hls::stream<data_t>& strm, data_t out[256][256]) {
    VITIS_LOOP_180_1: for (int i = 0; i < 256 * 256; i++) {
#pragma HLS PIPELINE II=1
...
#pragma HLS DATAFLOW
 read_input(A_in, inter_strm[0]);
    ...
    VITIS_LOOP_205_1: for (int t = 0; t < 30; t++) {
#pragma HLS UNROLL
 stencil_stage(inter_strm[t], inter_strm[t+1]);
    }

    write_output(inter_strm[30], A_out);
}
