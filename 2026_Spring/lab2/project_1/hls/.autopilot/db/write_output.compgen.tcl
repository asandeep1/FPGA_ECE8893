...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { inter_strm_30_dout { I 24 vector } inter_strm_30_empty_n { I 1 bit } inter_strm_30_read { O 1 bit } inter_strm_30_num_data_valid { I 10 vector } inter_strm_30_fifo_cap { I 10 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_out_r \
    op interface \
    ports { out_r_dout { I 64 vector } out_r_empty_n { I 1 bit } out_r_read { O 1 bit } out_r_num_data_valid { I 7 vector } out_r_fifo_cap { I 7 vector } } \
} "
}
