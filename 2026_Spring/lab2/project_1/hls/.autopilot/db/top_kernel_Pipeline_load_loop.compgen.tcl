...
set name top_kernel_urem_8ns_3ns_2_12_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln102 \
    op interface \
    ports { sext_ln102 { I 58 vector } } \
} "
}
