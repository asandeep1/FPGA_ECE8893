set moduleName top_kernel_Pipeline_row_loop_col_loop
set isTopModule 0
...
set cdfgNum 6
set C_modelName {top_kernel_Pipeline_row_loop_col_loop}
...
set C_modelArgList {
	{ empty int 1 regular  }
	{ mem_A int 24 regular {array 65536 { 2 0 } 1 1 } {global 2}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "empty", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "mem_A", "interface" : "memory", "bitwidth" : 24, "direction" : "READWRITE", "extern" : 0} ]}
...
set portList { 
	...
	{ mem_A_address1 sc_out sc_lv 16 signal 1 } 
	{ mem_A_ce1 sc_out sc_logic 1 signal 1 } 
	{ mem_A_we1 sc_out sc_logic 1 signal 1 } 
	{ mem_A_d1 sc_out sc_lv 24 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mem_A_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "mem_A", "role": "address1" }} , 
 	{ "name": "mem_A_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "mem_A", "role": "ce1" }} , 
 	{ "name": "mem_A_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "mem_A", "role": "we1" }} , 
 	{ "name": "mem_A_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "mem_A", "role": "d1" }}  ]}
...
set Spec2ImplPortList { 
	...
	mem_A { ap_memory {  { mem_A_address0 mem_address 1 16 }  { mem_A_ce0 mem_ce 1 1 }  { mem_A_we0 mem_we 1 1 }  { mem_A_d0 mem_din 1 24 }  { mem_A_q0 mem_dout 0 24 }  { mem_A_address1 MemPortADDR2 1 16 }  { mem_A_ce1 MemPortCE2 1 1 }  { mem_A_we1 MemPortWE2 1 1 }  { mem_A_d1 MemPortDIN2 1 24 } } }
}
