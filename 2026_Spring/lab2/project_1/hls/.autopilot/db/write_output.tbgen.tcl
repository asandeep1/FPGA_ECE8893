...
set C_modelArgList {
	{ inter_strm_30 int 24 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "inter_strm_30", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ out_r_num_data_valid sc_in sc_lv 7 signal 2 } 
	{ out_r_fifo_cap sc_in sc_lv 7 signal 2 } 
	...
	{ inter_strm_30_dout sc_in sc_lv 24 signal 0 } 
	{ inter_strm_30_empty_n sc_in sc_logic 1 signal 0 } 
	{ inter_strm_30_read sc_out sc_logic 1 signal 0 } 
	{ inter_strm_30_num_data_valid sc_in sc_lv 10 signal 0 } 
	{ inter_strm_30_fifo_cap sc_in sc_lv 10 signal 0 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out_r_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "out_r", "role": "num_data_valid" }} , 
 	{ "name": "out_r_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "out_r", "role": "fifo_cap" }} , 
 	...
 	{ "name": "inter_strm_30_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "inter_strm_30", "role": "dout" }} , 
 	{ "name": "inter_strm_30_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "inter_strm_30", "role": "empty_n" }} , 
 	{ "name": "inter_strm_30_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "inter_strm_30", "role": "read" }} , 
 	{ "name": "inter_strm_30_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "inter_strm_30", "role": "num_data_valid" }} , 
 	{ "name": "inter_strm_30_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "inter_strm_30", "role": "fifo_cap" }}  ]}
...
set Spec2ImplPortList { 
	inter_strm_30 { ap_fifo {  { inter_strm_30_dout fifo_data_in 0 24 }  { inter_strm_30_empty_n fifo_status 0 1 }  { inter_strm_30_read fifo_port_we 1 1 }  { inter_strm_30_num_data_valid fifo_status_num_data_valid 0 10 }  { inter_strm_30_fifo_cap fifo_update 0 10 } } }
	...
	out_r { ap_fifo {  { out_r_dout fifo_data_in 0 64 }  { out_r_empty_n fifo_status 0 1 }  { out_r_read fifo_port_we 1 1 }  { out_r_num_data_valid fifo_status_num_data_valid 0 7 }  { out_r_fifo_cap fifo_update 0 7 } } }
}
