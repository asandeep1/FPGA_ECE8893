...
output  [23:0] inter_strm_0_din;
input   inter_strm_0_full_n;
output   inter_strm_0_write;
...
reg   [63:0] in_read_reg_161;
reg   [0:0] icmp_ln125_reg_166;
reg    ap_block_pp0_stage0_11001;
wire   [23:0] trunc_ln128_fu_150_p1;
reg   [23:0] trunc_ln128_reg_176;
wire    ap_loop_init;
wire    ap_block_pp0_stage0;
wire  signed [63:0] sext_ln125_fu_139_p1;
reg   [15:0] i1_fu_64;
wire   [15:0] i_fu_113_p2;
reg   [15:0] ap_sig_allocacmp_i1_load;
reg    ap_block_pp0_stage0_01001_grp1;
wire   [61:0] trunc_ln_fu_130_p4;
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln125_fu_119_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_grp1) & (first_iter_0_reg_93 == 1'd1))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter10 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001_grp1))) begin
        inter_strm_0_write = 1'b1;
    end else begin
        inter_strm_0_write = 1'b0;
    end
end

always @ (*) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001_grp1) & (first_iter_0_reg_93 == 1'd1))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001_grp1 = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter10 == 1'b1) & (inter_strm_0_full_n == 1'b0)) | ((ap_enable_reg_pp0_iter9 == 1'b1) & (m_axi_gmem0_0_RVALID == 1'b0)) | ((ap_start_int == 1'b1) & (1'b1 == ap_block_state1_pp0_stage0_iter0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter10 == 1'b1) & (inter_strm_0_full_n == 1'b0)) | ((ap_enable_reg_pp0_iter9 == 1'b1) & (m_axi_gmem0_0_RVALID == 1'b0)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_block_state2_io_grp1)) | ((ap_start_int == 1'b1) & (1'b1 == ap_block_state1_pp0_stage0_iter0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001_grp1 = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter10 == 1'b1) & (inter_strm_0_full_n == 1'b0)) | ((ap_enable_reg_pp0_iter9 == 1'b1) & (m_axi_gmem0_0_RVALID == 1'b0)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_block_state2_io_grp1)) | ((ap_start_int == 1'b1) & (1'b1 == ap_block_state1_pp0_stage0_iter0)));
end

assign ap_block_pp0_stage0_grp1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter10 == 1'b1) & (inter_strm_0_full_n == 1'b0)) | ((ap_enable_reg_pp0_iter9 == 1'b1) & (m_axi_gmem0_0_RVALID == 1'b0)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_block_state2_io_grp1)) | ((ap_start_int == 1'b1) & (1'b1 == ap_block_state1_pp0_stage0_iter0)));
end
...
always @ (*) begin
    ap_condition_333 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln125_reg_166 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001));
end
...
assign i_fu_113_p2 = (ap_sig_allocacmp_i1_load + 16'd1);

assign icmp_ln125_fu_119_p2 = ((ap_sig_allocacmp_i1_load == 16'd65535) ? 1'b1 : 1'b0);

assign inter_strm_0_din = trunc_ln128_reg_176;

assign m_axi_gmem0_0_ARADDR = sext_ln125_fu_139_p1;
...
assign m_axi_gmem0_0_ARLEN = 64'd65536;
...
assign sext_ln125_fu_139_p1 = $signed(trunc_ln_fu_130_p4);

assign start_out = real_start;

assign trunc_ln128_fu_150_p1 = m_axi_gmem0_0_RDATA[23:0];

assign trunc_ln_fu_130_p4 = {{in_read_reg_161[63:2]}};
