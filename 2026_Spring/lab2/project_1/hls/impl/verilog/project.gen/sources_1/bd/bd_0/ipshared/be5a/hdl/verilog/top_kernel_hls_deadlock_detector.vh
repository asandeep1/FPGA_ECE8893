...
reg [15:0] trans_in_cnt_1;// for process stencil_stage_1_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_1 <= 16'h0;
    end
    else if (stencil_stage_1_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_1;// for process stencil_stage_1_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_1 <= 16'h0;
    end
    else if (stencil_stage_1_U0.ap_done == 1'b1 && stencil_stage_1_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_2;// for process stencil_stage_2_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_2 <= 16'h0;
    end
    else if (stencil_stage_2_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_2;// for process stencil_stage_2_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_2 <= 16'h0;
    end
    else if (stencil_stage_2_U0.ap_done == 1'b1 && stencil_stage_2_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_3;// for process stencil_stage_3_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_3 <= 16'h0;
    end
    else if (stencil_stage_3_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_3;// for process stencil_stage_3_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_3 <= 16'h0;
    end
    else if (stencil_stage_3_U0.ap_done == 1'b1 && stencil_stage_3_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_4;// for process stencil_stage_4_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_4 <= 16'h0;
    end
    else if (stencil_stage_4_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_4;// for process stencil_stage_4_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_4 <= 16'h0;
    end
    else if (stencil_stage_4_U0.ap_done == 1'b1 && stencil_stage_4_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_5;// for process stencil_stage_5_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_5 <= 16'h0;
    end
    else if (stencil_stage_5_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_5;// for process stencil_stage_5_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_5 <= 16'h0;
    end
    else if (stencil_stage_5_U0.ap_done == 1'b1 && stencil_stage_5_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_6;// for process stencil_stage_6_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_6 <= 16'h0;
    end
    else if (stencil_stage_6_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_6;// for process stencil_stage_6_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_6 <= 16'h0;
    end
    else if (stencil_stage_6_U0.ap_done == 1'b1 && stencil_stage_6_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_7;// for process stencil_stage_7_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_7 <= 16'h0;
    end
    else if (stencil_stage_7_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_7;// for process stencil_stage_7_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_7 <= 16'h0;
    end
    else if (stencil_stage_7_U0.ap_done == 1'b1 && stencil_stage_7_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_8;// for process stencil_stage_8_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_8 <= 16'h0;
    end
    else if (stencil_stage_8_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_8;// for process stencil_stage_8_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_8 <= 16'h0;
    end
    else if (stencil_stage_8_U0.ap_done == 1'b1 && stencil_stage_8_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_9;// for process stencil_stage_9_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_9 <= 16'h0;
    end
    else if (stencil_stage_9_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_9;// for process stencil_stage_9_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_9 <= 16'h0;
    end
    else if (stencil_stage_9_U0.ap_done == 1'b1 && stencil_stage_9_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_10;// for process stencil_stage_10_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_10 <= 16'h0;
    end
    else if (stencil_stage_10_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_10;// for process stencil_stage_10_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_10 <= 16'h0;
    end
    else if (stencil_stage_10_U0.ap_done == 1'b1 && stencil_stage_10_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_11;// for process stencil_stage_11_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_11 <= 16'h0;
    end
    else if (stencil_stage_11_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_11;// for process stencil_stage_11_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_11 <= 16'h0;
    end
    else if (stencil_stage_11_U0.ap_done == 1'b1 && stencil_stage_11_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_12;// for process stencil_stage_12_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_12 <= 16'h0;
    end
    else if (stencil_stage_12_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_12;// for process stencil_stage_12_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_12 <= 16'h0;
    end
    else if (stencil_stage_12_U0.ap_done == 1'b1 && stencil_stage_12_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_13;// for process stencil_stage_13_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_13 <= 16'h0;
    end
    else if (stencil_stage_13_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_13;// for process stencil_stage_13_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_13 <= 16'h0;
    end
    else if (stencil_stage_13_U0.ap_done == 1'b1 && stencil_stage_13_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_14;// for process stencil_stage_14_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_14 <= 16'h0;
    end
    else if (stencil_stage_14_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_14;// for process stencil_stage_14_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_14 <= 16'h0;
    end
    else if (stencil_stage_14_U0.ap_done == 1'b1 && stencil_stage_14_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_15;// for process stencil_stage_15_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_15 <= 16'h0;
    end
    else if (stencil_stage_15_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_15;// for process stencil_stage_15_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_15 <= 16'h0;
    end
    else if (stencil_stage_15_U0.ap_done == 1'b1 && stencil_stage_15_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_16;// for process stencil_stage_16_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_16 <= 16'h0;
    end
    else if (stencil_stage_16_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_16;// for process stencil_stage_16_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_16 <= 16'h0;
    end
    else if (stencil_stage_16_U0.ap_done == 1'b1 && stencil_stage_16_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_17;// for process stencil_stage_17_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_17 <= 16'h0;
    end
    else if (stencil_stage_17_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_17;// for process stencil_stage_17_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_17 <= 16'h0;
    end
    else if (stencil_stage_17_U0.ap_done == 1'b1 && stencil_stage_17_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_18;// for process stencil_stage_18_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_18 <= 16'h0;
    end
    else if (stencil_stage_18_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_18;// for process stencil_stage_18_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_18 <= 16'h0;
    end
    else if (stencil_stage_18_U0.ap_done == 1'b1 && stencil_stage_18_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_19;// for process stencil_stage_19_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_19 <= 16'h0;
    end
    else if (stencil_stage_19_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_19;// for process stencil_stage_19_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_19 <= 16'h0;
    end
    else if (stencil_stage_19_U0.ap_done == 1'b1 && stencil_stage_19_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_20;// for process stencil_stage_20_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_20 <= 16'h0;
    end
    else if (stencil_stage_20_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_20;// for process stencil_stage_20_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_20 <= 16'h0;
    end
    else if (stencil_stage_20_U0.ap_done == 1'b1 && stencil_stage_20_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_21;// for process stencil_stage_21_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_21 <= 16'h0;
    end
    else if (stencil_stage_21_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_21;// for process stencil_stage_21_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_21 <= 16'h0;
    end
    else if (stencil_stage_21_U0.ap_done == 1'b1 && stencil_stage_21_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_22;// for process stencil_stage_22_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_22 <= 16'h0;
    end
    else if (stencil_stage_22_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_22;// for process stencil_stage_22_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_22 <= 16'h0;
    end
    else if (stencil_stage_22_U0.ap_done == 1'b1 && stencil_stage_22_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_23;// for process stencil_stage_23_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_23 <= 16'h0;
    end
    else if (stencil_stage_23_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_23;// for process stencil_stage_23_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_23 <= 16'h0;
    end
    else if (stencil_stage_23_U0.ap_done == 1'b1 && stencil_stage_23_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_24;// for process stencil_stage_24_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_24 <= 16'h0;
    end
    else if (stencil_stage_24_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_24;// for process stencil_stage_24_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_24 <= 16'h0;
    end
    else if (stencil_stage_24_U0.ap_done == 1'b1 && stencil_stage_24_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_25;// for process stencil_stage_25_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_25 <= 16'h0;
    end
    else if (stencil_stage_25_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_25;// for process stencil_stage_25_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_25 <= 16'h0;
    end
    else if (stencil_stage_25_U0.ap_done == 1'b1 && stencil_stage_25_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_26;// for process stencil_stage_26_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_26 <= 16'h0;
    end
    else if (stencil_stage_26_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_26;// for process stencil_stage_26_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_26 <= 16'h0;
    end
    else if (stencil_stage_26_U0.ap_done == 1'b1 && stencil_stage_26_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_27;// for process stencil_stage_27_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_27 <= 16'h0;
    end
    else if (stencil_stage_27_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_27;// for process stencil_stage_27_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_27 <= 16'h0;
    end
    else if (stencil_stage_27_U0.ap_done == 1'b1 && stencil_stage_27_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_28;// for process stencil_stage_28_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_28 <= 16'h0;
    end
    else if (stencil_stage_28_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_28;// for process stencil_stage_28_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_28 <= 16'h0;
    end
    else if (stencil_stage_28_U0.ap_done == 1'b1 && stencil_stage_28_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_29;// for process stencil_stage_29_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_29 <= 16'h0;
    end
    else if (stencil_stage_29_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_29;// for process stencil_stage_29_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_29 <= 16'h0;
    end
    else if (stencil_stage_29_U0.ap_done == 1'b1 && stencil_stage_29_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_30;// for process entry_proc_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
...
reg [15:0] trans_out_cnt_30;// for process entry_proc_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
    ...
    top_kernel_hls_deadlock_detect_unit #(33, 0, 2, 2) top_kernel_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_0_data_FIFO_blk[0] = 1'b0 | (~entry_proc_U0.A_out_c_blk_n);
    assign proc_0_data_PIPO_blk[0] = 1'b0;
    assign proc_0_start_FIFO_blk[0] = 1'b0 | (~start_for_write_output_U0_U.if_full_n & entry_proc_U0.ap_start & ~entry_proc_U0.real_start & (trans_in_cnt_30 == trans_out_cnt_30) & ~start_for_write_output_U0_U.if_read);
    ...
    top_kernel_hls_deadlock_detect_unit #(33, 1, 2, 2) top_kernel_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~read_input_U0.inter_strm_0_blk_n);
    assign proc_1_data_PIPO_blk[0] = 1'b0;
    assign proc_1_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_1_U0_U.if_full_n & read_input_U0.ap_start & ~read_input_U0.real_start & (trans_in_cnt_0 == trans_out_cnt_0) & ~start_for_stencil_stage_1_U0_U.if_read);
    ...
    // Process: stencil_stage_1_U0
    top_kernel_hls_deadlock_detect_unit #(33, 2, 2, 2) top_kernel_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_1_U0.inter_strm_0_blk_n);
    assign proc_2_data_PIPO_blk[0] = 1'b0;
    assign proc_2_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_1_U0_U.if_empty_n & stencil_stage_1_U0.ap_idle & ~start_for_stencil_stage_1_U0_U.if_write);
    assign proc_2_TLF_FIFO_blk[0] = 1'b0;
    assign proc_2_input_sync_blk[0] = 1'b0;
    assign proc_2_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_2[0] = dl_detect_out ? proc_dep_vld_vec_2_reg[0] : (proc_2_data_FIFO_blk[0] | proc_2_data_PIPO_blk[0] | proc_2_start_FIFO_blk[0] | proc_2_TLF_FIFO_blk[0] | proc_2_input_sync_blk[0] | proc_2_output_sync_blk[0]);
    assign proc_2_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_1_U0.inter_strm_1_blk_n);
    assign proc_2_data_PIPO_blk[1] = 1'b0;
    assign proc_2_start_FIFO_blk[1] = 1'b0 | (~start_for_stencil_stage_2_U0_U.if_full_n & stencil_stage_1_U0.ap_start & ~stencil_stage_1_U0.real_start & (trans_in_cnt_1 == trans_out_cnt_1) & ~start_for_stencil_stage_2_U0_U.if_read);
    ...
    // Process: stencil_stage_2_U0
    top_kernel_hls_deadlock_detect_unit #(33, 3, 2, 2) top_kernel_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_2_U0.inter_strm_1_blk_n);
    assign proc_3_data_PIPO_blk[0] = 1'b0;
    assign proc_3_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_2_U0_U.if_empty_n & stencil_stage_2_U0.ap_idle & ~start_for_stencil_stage_2_U0_U.if_write);
    assign proc_3_TLF_FIFO_blk[0] = 1'b0;
    assign proc_3_input_sync_blk[0] = 1'b0;
    assign proc_3_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_3[0] = dl_detect_out ? proc_dep_vld_vec_3_reg[0] : (proc_3_data_FIFO_blk[0] | proc_3_data_PIPO_blk[0] | proc_3_start_FIFO_blk[0] | proc_3_TLF_FIFO_blk[0] | proc_3_input_sync_blk[0] | proc_3_output_sync_blk[0]);
    assign proc_3_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_2_U0.inter_strm_2_blk_n);
    assign proc_3_data_PIPO_blk[1] = 1'b0;
    assign proc_3_start_FIFO_blk[1] = 1'b0 | (~start_for_stencil_stage_3_U0_U.if_full_n & stencil_stage_2_U0.ap_start & ~stencil_stage_2_U0.real_start & (trans_in_cnt_2 == trans_out_cnt_2) & ~start_for_stencil_stage_3_U0_U.if_read);
    ...
    // Process: stencil_stage_3_U0
    top_kernel_hls_deadlock_detect_unit #(33, 4, 2, 2) top_kernel_hls_deadlock_detect_unit_4 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_4_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_3_U0.inter_strm_2_blk_n);
    assign proc_4_data_PIPO_blk[0] = 1'b0;
    assign proc_4_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_3_U0_U.if_empty_n & stencil_stage_3_U0.ap_idle & ~start_for_stencil_stage_3_U0_U.if_write);
    assign proc_4_TLF_FIFO_blk[0] = 1'b0;
    assign proc_4_input_sync_blk[0] = 1'b0;
    assign proc_4_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_4[0] = dl_detect_out ? proc_dep_vld_vec_4_reg[0] : (proc_4_data_FIFO_blk[0] | proc_4_data_PIPO_blk[0] | proc_4_start_FIFO_blk[0] | proc_4_TLF_FIFO_blk[0] | proc_4_input_sync_blk[0] | proc_4_output_sync_blk[0]);
    assign proc_4_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_3_U0.inter_strm_3_blk_n);
    assign proc_4_data_PIPO_blk[1] = 1'b0;
    assign proc_4_start_FIFO_blk[1] = 1'b0 | (~start_for_stencil_stage_4_U0_U.if_full_n & stencil_stage_3_U0.ap_start & ~stencil_stage_3_U0.real_start & (trans_in_cnt_3 == trans_out_cnt_3) & ~start_for_stencil_stage_4_U0_U.if_read);
    ...
    // Process: stencil_stage_4_U0
    top_kernel_hls_deadlock_detect_unit #(33, 5, 2, 2) top_kernel_hls_deadlock_detect_unit_5 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_5_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_4_U0.inter_strm_3_blk_n);
    assign proc_5_data_PIPO_blk[0] = 1'b0;
    assign proc_5_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_4_U0_U.if_empty_n & stencil_stage_4_U0.ap_idle & ~start_for_stencil_stage_4_U0_U.if_write);
    assign proc_5_TLF_FIFO_blk[0] = 1'b0;
    assign proc_5_input_sync_blk[0] = 1'b0;
    assign proc_5_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_5[0] = dl_detect_out ? proc_dep_vld_vec_5_reg[0] : (proc_5_data_FIFO_blk[0] | proc_5_data_PIPO_blk[0] | proc_5_start_FIFO_blk[0] | proc_5_TLF_FIFO_blk[0] | proc_5_input_sync_blk[0] | proc_5_output_sync_blk[0]);
    assign proc_5_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_4_U0.inter_strm_4_blk_n);
    assign proc_5_data_PIPO_blk[1] = 1'b0;
    assign proc_5_start_FIFO_blk[1] = 1'b0 | (~start_for_stencil_stage_5_U0_U.if_full_n & stencil_stage_4_U0.ap_start & ~stencil_stage_4_U0.real_start & (trans_in_cnt_4 == trans_out_cnt_4) & ~start_for_stencil_stage_5_U0_U.if_read);
    ...
    // Process: stencil_stage_5_U0
    top_kernel_hls_deadlock_detect_unit #(33, 6, 2, 2) top_kernel_hls_deadlock_detect_unit_6 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_6_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_5_U0.inter_strm_4_blk_n);
    assign proc_6_data_PIPO_blk[0] = 1'b0;
    assign proc_6_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_5_U0_U.if_empty_n & stencil_stage_5_U0.ap_idle & ~start_for_stencil_stage_5_U0_U.if_write);
    assign proc_6_TLF_FIFO_blk[0] = 1'b0;
    assign proc_6_input_sync_blk[0] = 1'b0;
    assign proc_6_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_6[0] = dl_detect_out ? proc_dep_vld_vec_6_reg[0] : (proc_6_data_FIFO_blk[0] | proc_6_data_PIPO_blk[0] | proc_6_start_FIFO_blk[0] | proc_6_TLF_FIFO_blk[0] | proc_6_input_sync_blk[0] | proc_6_output_sync_blk[0]);
    assign proc_6_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_5_U0.inter_strm_5_blk_n);
    assign proc_6_data_PIPO_blk[1] = 1'b0;
    assign proc_6_start_FIFO_blk[1] = 1'b0 | (~start_for_stencil_stage_6_U0_U.if_full_n & stencil_stage_5_U0.ap_start & ~stencil_stage_5_U0.real_start & (trans_in_cnt_5 == trans_out_cnt_5) & ~start_for_stencil_stage_6_U0_U.if_read);
    ...
    // Process: stencil_stage_6_U0
    top_kernel_hls_deadlock_detect_unit #(33, 7, 2, 2) top_kernel_hls_deadlock_detect_unit_7 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_7_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_6_U0.inter_strm_5_blk_n);
    assign proc_7_data_PIPO_blk[0] = 1'b0;
    assign proc_7_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_6_U0_U.if_empty_n & stencil_stage_6_U0.ap_idle & ~start_for_stencil_stage_6_U0_U.if_write);
    assign proc_7_TLF_FIFO_blk[0] = 1'b0;
    assign proc_7_input_sync_blk[0] = 1'b0;
    assign proc_7_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_7[0] = dl_detect_out ? proc_dep_vld_vec_7_reg[0] : (proc_7_data_FIFO_blk[0] | proc_7_data_PIPO_blk[0] | proc_7_start_FIFO_blk[0] | proc_7_TLF_FIFO_blk[0] | proc_7_input_sync_blk[0] | proc_7_output_sync_blk[0]);
    assign proc_7_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_6_U0.inter_strm_6_blk_n);
    assign proc_7_data_PIPO_blk[1] = 1'b0;
    assign proc_7_start_FIFO_blk[1] = 1'b0 | (~start_for_stencil_stage_7_U0_U.if_full_n & stencil_stage_6_U0.ap_start & ~stencil_stage_6_U0.real_start & (trans_in_cnt_6 == trans_out_cnt_6) & ~start_for_stencil_stage_7_U0_U.if_read);
    ...
    // Process: stencil_stage_7_U0
    top_kernel_hls_deadlock_detect_unit #(33, 8, 2, 2) top_kernel_hls_deadlock_detect_unit_8 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_8_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_7_U0.inter_strm_6_blk_n);
    assign proc_8_data_PIPO_blk[0] = 1'b0;
    assign proc_8_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_7_U0_U.if_empty_n & stencil_stage_7_U0.ap_idle & ~start_for_stencil_stage_7_U0_U.if_write);
    assign proc_8_TLF_FIFO_blk[0] = 1'b0;
    assign proc_8_input_sync_blk[0] = 1'b0;
    assign proc_8_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_8[0] = dl_detect_out ? proc_dep_vld_vec_8_reg[0] : (proc_8_data_FIFO_blk[0] | proc_8_data_PIPO_blk[0] | proc_8_start_FIFO_blk[0] | proc_8_TLF_FIFO_blk[0] | proc_8_input_sync_blk[0] | proc_8_output_sync_blk[0]);
    assign proc_8_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_7_U0.inter_strm_7_blk_n);
    assign proc_8_data_PIPO_blk[1] = 1'b0;
    assign proc_8_start_FIFO_blk[1] = 1'b0 | (~start_for_stencil_stage_8_U0_U.if_full_n & stencil_stage_7_U0.ap_start & ~stencil_stage_7_U0.real_start & (trans_in_cnt_7 == trans_out_cnt_7) & ~start_for_stencil_stage_8_U0_U.if_read);
    ...
    // Process: stencil_stage_8_U0
    top_kernel_hls_deadlock_detect_unit #(33, 9, 2, 2) top_kernel_hls_deadlock_detect_unit_9 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_9_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_8_U0.inter_strm_7_blk_n);
    assign proc_9_data_PIPO_blk[0] = 1'b0;
    assign proc_9_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_8_U0_U.if_empty_n & stencil_stage_8_U0.ap_idle & ~start_for_stencil_stage_8_U0_U.if_write);
    assign proc_9_TLF_FIFO_blk[0] = 1'b0;
    assign proc_9_input_sync_blk[0] = 1'b0;
    assign proc_9_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_9[0] = dl_detect_out ? proc_dep_vld_vec_9_reg[0] : (proc_9_data_FIFO_blk[0] | proc_9_data_PIPO_blk[0] | proc_9_start_FIFO_blk[0] | proc_9_TLF_FIFO_blk[0] | proc_9_input_sync_blk[0] | proc_9_output_sync_blk[0]);
    assign proc_9_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_8_U0.inter_strm_8_blk_n);
    assign proc_9_data_PIPO_blk[1] = 1'b0;
    assign proc_9_start_FIFO_blk[1] = 1'b0 | (~start_for_stencil_stage_9_U0_U.if_full_n & stencil_stage_8_U0.ap_start & ~stencil_stage_8_U0.real_start & (trans_in_cnt_8 == trans_out_cnt_8) & ~start_for_stencil_stage_9_U0_U.if_read);
    ...
    // Process: stencil_stage_9_U0
    top_kernel_hls_deadlock_detect_unit #(33, 10, 2, 2) top_kernel_hls_deadlock_detect_unit_10 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_10_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_9_U0.inter_strm_8_blk_n);
    assign proc_10_data_PIPO_blk[0] = 1'b0;
    assign proc_10_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_9_U0_U.if_empty_n & stencil_stage_9_U0.ap_idle & ~start_for_stencil_stage_9_U0_U.if_write);
    assign proc_10_TLF_FIFO_blk[0] = 1'b0;
    assign proc_10_input_sync_blk[0] = 1'b0;
    assign proc_10_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_10[0] = dl_detect_out ? proc_dep_vld_vec_10_reg[0] : (proc_10_data_FIFO_blk[0] | proc_10_data_PIPO_blk[0] | proc_10_start_FIFO_blk[0] | proc_10_TLF_FIFO_blk[0] | proc_10_input_sync_blk[0] | proc_10_output_sync_blk[0]);
    assign proc_10_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_9_U0.inter_strm_9_blk_n);
    assign proc_10_data_PIPO_blk[1] = 1'b0;
    assign proc_10_start_FIFO_blk[1] = 1'b0 | (~start_for_stencil_stage_10_U0_U.if_full_n & stencil_stage_9_U0.ap_start & ~stencil_stage_9_U0.real_start & (trans_in_cnt_9 == trans_out_cnt_9) & ~start_for_stencil_stage_10_U0_U.if_read);
    ...
    // Process: stencil_stage_10_U0
    top_kernel_hls_deadlock_detect_unit #(33, 11, 2, 2) top_kernel_hls_deadlock_detect_unit_11 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_11_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_10_U0.inter_strm_9_blk_n);
    assign proc_11_data_PIPO_blk[0] = 1'b0;
    assign proc_11_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_10_U0_U.if_empty_n & stencil_stage_10_U0.ap_idle & ~start_for_stencil_stage_10_U0_U.if_write);
    assign proc_11_TLF_FIFO_blk[0] = 1'b0;
    assign proc_11_input_sync_blk[0] = 1'b0;
    assign proc_11_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_11[0] = dl_detect_out ? proc_dep_vld_vec_11_reg[0] : (proc_11_data_FIFO_blk[0] | proc_11_data_PIPO_blk[0] | proc_11_start_FIFO_blk[0] | proc_11_TLF_FIFO_blk[0] | proc_11_input_sync_blk[0] | proc_11_output_sync_blk[0]);
    assign proc_11_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_10_U0.inter_strm_10_blk_n);
    assign proc_11_data_PIPO_blk[1] = 1'b0;
    assign proc_11_start_FIFO_blk[1] = 1'b0 | (~start_for_stencil_stage_11_U0_U.if_full_n & stencil_stage_10_U0.ap_start & ~stencil_stage_10_U0.real_start & (trans_in_cnt_10 == trans_out_cnt_10) & ~start_for_stencil_stage_11_U0_U.if_read);
    ...
    // Process: stencil_stage_11_U0
    top_kernel_hls_deadlock_detect_unit #(33, 12, 2, 2) top_kernel_hls_deadlock_detect_unit_12 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_12_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_11_U0.inter_strm_10_blk_n);
    assign proc_12_data_PIPO_blk[0] = 1'b0;
    assign proc_12_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_11_U0_U.if_empty_n & stencil_stage_11_U0.ap_idle & ~start_for_stencil_stage_11_U0_U.if_write);
    assign proc_12_TLF_FIFO_blk[0] = 1'b0;
    assign proc_12_input_sync_blk[0] = 1'b0;
    assign proc_12_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_12[0] = dl_detect_out ? proc_dep_vld_vec_12_reg[0] : (proc_12_data_FIFO_blk[0] | proc_12_data_PIPO_blk[0] | proc_12_start_FIFO_blk[0] | proc_12_TLF_FIFO_blk[0] | proc_12_input_sync_blk[0] | proc_12_output_sync_blk[0]);
    assign proc_12_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_11_U0.inter_strm_11_blk_n);
    assign proc_12_data_PIPO_blk[1] = 1'b0;
    assign proc_12_start_FIFO_blk[1] = 1'b0 | (~start_for_stencil_stage_12_U0_U.if_full_n & stencil_stage_11_U0.ap_start & ~stencil_stage_11_U0.real_start & (trans_in_cnt_11 == trans_out_cnt_11) & ~start_for_stencil_stage_12_U0_U.if_read);
    ...
    // Process: stencil_stage_12_U0
    top_kernel_hls_deadlock_detect_unit #(33, 13, 2, 2) top_kernel_hls_deadlock_detect_unit_13 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_13_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_12_U0.inter_strm_11_blk_n);
    assign proc_13_data_PIPO_blk[0] = 1'b0;
    assign proc_13_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_12_U0_U.if_empty_n & stencil_stage_12_U0.ap_idle & ~start_for_stencil_stage_12_U0_U.if_write);
    assign proc_13_TLF_FIFO_blk[0] = 1'b0;
    assign proc_13_input_sync_blk[0] = 1'b0;
    assign proc_13_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_13[0] = dl_detect_out ? proc_dep_vld_vec_13_reg[0] : (proc_13_data_FIFO_blk[0] | proc_13_data_PIPO_blk[0] | proc_13_start_FIFO_blk[0] | proc_13_TLF_FIFO_blk[0] | proc_13_input_sync_blk[0] | proc_13_output_sync_blk[0]);
    assign proc_13_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_12_U0.inter_strm_12_blk_n);
    assign proc_13_data_PIPO_blk[1] = 1'b0;
    assign proc_13_start_FIFO_blk[1] = 1'b0 | (~start_for_stencil_stage_13_U0_U.if_full_n & stencil_stage_12_U0.ap_start & ~stencil_stage_12_U0.real_start & (trans_in_cnt_12 == trans_out_cnt_12) & ~start_for_stencil_stage_13_U0_U.if_read);
    ...
    // Process: stencil_stage_13_U0
    top_kernel_hls_deadlock_detect_unit #(33, 14, 2, 2) top_kernel_hls_deadlock_detect_unit_14 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_14_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_13_U0.inter_strm_12_blk_n);
    assign proc_14_data_PIPO_blk[0] = 1'b0;
    assign proc_14_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_13_U0_U.if_empty_n & stencil_stage_13_U0.ap_idle & ~start_for_stencil_stage_13_U0_U.if_write);
    assign proc_14_TLF_FIFO_blk[0] = 1'b0;
    assign proc_14_input_sync_blk[0] = 1'b0;
    assign proc_14_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_14[0] = dl_detect_out ? proc_dep_vld_vec_14_reg[0] : (proc_14_data_FIFO_blk[0] | proc_14_data_PIPO_blk[0] | proc_14_start_FIFO_blk[0] | proc_14_TLF_FIFO_blk[0] | proc_14_input_sync_blk[0] | proc_14_output_sync_blk[0]);
    assign proc_14_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_13_U0.inter_strm_13_blk_n);
    assign proc_14_data_PIPO_blk[1] = 1'b0;
    assign proc_14_start_FIFO_blk[1] = 1'b0 | (~start_for_stencil_stage_14_U0_U.if_full_n & stencil_stage_13_U0.ap_start & ~stencil_stage_13_U0.real_start & (trans_in_cnt_13 == trans_out_cnt_13) & ~start_for_stencil_stage_14_U0_U.if_read);
    ...
    // Process: stencil_stage_14_U0
    top_kernel_hls_deadlock_detect_unit #(33, 15, 2, 2) top_kernel_hls_deadlock_detect_unit_15 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_15_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_14_U0.inter_strm_13_blk_n);
    assign proc_15_data_PIPO_blk[0] = 1'b0;
    assign proc_15_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_14_U0_U.if_empty_n & stencil_stage_14_U0.ap_idle & ~start_for_stencil_stage_14_U0_U.if_write);
    assign proc_15_TLF_FIFO_blk[0] = 1'b0;
    assign proc_15_input_sync_blk[0] = 1'b0;
    assign proc_15_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_15[0] = dl_detect_out ? proc_dep_vld_vec_15_reg[0] : (proc_15_data_FIFO_blk[0] | proc_15_data_PIPO_blk[0] | proc_15_start_FIFO_blk[0] | proc_15_TLF_FIFO_blk[0] | proc_15_input_sync_blk[0] | proc_15_output_sync_blk[0]);
    assign proc_15_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_14_U0.inter_strm_14_blk_n);
    assign proc_15_data_PIPO_blk[1] = 1'b0;
    assign proc_15_start_FIFO_blk[1] = 1'b0 | (~start_for_stencil_stage_15_U0_U.if_full_n & stencil_stage_14_U0.ap_start & ~stencil_stage_14_U0.real_start & (trans_in_cnt_14 == trans_out_cnt_14) & ~start_for_stencil_stage_15_U0_U.if_read);
    ...
    // Process: stencil_stage_15_U0
    top_kernel_hls_deadlock_detect_unit #(33, 16, 2, 2) top_kernel_hls_deadlock_detect_unit_16 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_16_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_15_U0.inter_strm_14_blk_n);
    assign proc_16_data_PIPO_blk[0] = 1'b0;
    assign proc_16_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_15_U0_U.if_empty_n & stencil_stage_15_U0.ap_idle & ~start_for_stencil_stage_15_U0_U.if_write);
    assign proc_16_TLF_FIFO_blk[0] = 1'b0;
    assign proc_16_input_sync_blk[0] = 1'b0;
    assign proc_16_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_16[0] = dl_detect_out ? proc_dep_vld_vec_16_reg[0] : (proc_16_data_FIFO_blk[0] | proc_16_data_PIPO_blk[0] | proc_16_start_FIFO_blk[0] | proc_16_TLF_FIFO_blk[0] | proc_16_input_sync_blk[0] | proc_16_output_sync_blk[0]);
    assign proc_16_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_15_U0.inter_strm_15_blk_n);
    assign proc_16_data_PIPO_blk[1] = 1'b0;
    assign proc_16_start_FIFO_blk[1] = 1'b0 | (~start_for_stencil_stage_16_U0_U.if_full_n & stencil_stage_15_U0.ap_start & ~stencil_stage_15_U0.real_start & (trans_in_cnt_15 == trans_out_cnt_15) & ~start_for_stencil_stage_16_U0_U.if_read);
    ...
    // Process: stencil_stage_16_U0
    top_kernel_hls_deadlock_detect_unit #(33, 17, 2, 2) top_kernel_hls_deadlock_detect_unit_17 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_17_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_16_U0.inter_strm_15_blk_n);
    assign proc_17_data_PIPO_blk[0] = 1'b0;
    assign proc_17_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_16_U0_U.if_empty_n & stencil_stage_16_U0.ap_idle & ~start_for_stencil_stage_16_U0_U.if_write);
    assign proc_17_TLF_FIFO_blk[0] = 1'b0;
    assign proc_17_input_sync_blk[0] = 1'b0;
    assign proc_17_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_17[0] = dl_detect_out ? proc_dep_vld_vec_17_reg[0] : (proc_17_data_FIFO_blk[0] | proc_17_data_PIPO_blk[0] | proc_17_start_FIFO_blk[0] | proc_17_TLF_FIFO_blk[0] | proc_17_input_sync_blk[0] | proc_17_output_sync_blk[0]);
    assign proc_17_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_16_U0.inter_strm_16_blk_n);
    assign proc_17_data_PIPO_blk[1] = 1'b0;
    assign proc_17_start_FIFO_blk[1] = 1'b0 | (~start_for_stencil_stage_17_U0_U.if_full_n & stencil_stage_16_U0.ap_start & ~stencil_stage_16_U0.real_start & (trans_in_cnt_16 == trans_out_cnt_16) & ~start_for_stencil_stage_17_U0_U.if_read);
    ...
    // Process: stencil_stage_17_U0
    top_kernel_hls_deadlock_detect_unit #(33, 18, 2, 2) top_kernel_hls_deadlock_detect_unit_18 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_18_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_17_U0.inter_strm_16_blk_n);
    assign proc_18_data_PIPO_blk[0] = 1'b0;
    assign proc_18_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_17_U0_U.if_empty_n & stencil_stage_17_U0.ap_idle & ~start_for_stencil_stage_17_U0_U.if_write);
    assign proc_18_TLF_FIFO_blk[0] = 1'b0;
    assign proc_18_input_sync_blk[0] = 1'b0;
    assign proc_18_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_18[0] = dl_detect_out ? proc_dep_vld_vec_18_reg[0] : (proc_18_data_FIFO_blk[0] | proc_18_data_PIPO_blk[0] | proc_18_start_FIFO_blk[0] | proc_18_TLF_FIFO_blk[0] | proc_18_input_sync_blk[0] | proc_18_output_sync_blk[0]);
    assign proc_18_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_17_U0.inter_strm_17_blk_n);
    assign proc_18_data_PIPO_blk[1] = 1'b0;
    assign proc_18_start_FIFO_blk[1] = 1'b0 | (~start_for_stencil_stage_18_U0_U.if_full_n & stencil_stage_17_U0.ap_start & ~stencil_stage_17_U0.real_start & (trans_in_cnt_17 == trans_out_cnt_17) & ~start_for_stencil_stage_18_U0_U.if_read);
    ...
    // Process: stencil_stage_18_U0
    top_kernel_hls_deadlock_detect_unit #(33, 19, 2, 2) top_kernel_hls_deadlock_detect_unit_19 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_19_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_18_U0.inter_strm_17_blk_n);
    assign proc_19_data_PIPO_blk[0] = 1'b0;
    assign proc_19_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_18_U0_U.if_empty_n & stencil_stage_18_U0.ap_idle & ~start_for_stencil_stage_18_U0_U.if_write);
    assign proc_19_TLF_FIFO_blk[0] = 1'b0;
    assign proc_19_input_sync_blk[0] = 1'b0;
    assign proc_19_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_19[0] = dl_detect_out ? proc_dep_vld_vec_19_reg[0] : (proc_19_data_FIFO_blk[0] | proc_19_data_PIPO_blk[0] | proc_19_start_FIFO_blk[0] | proc_19_TLF_FIFO_blk[0] | proc_19_input_sync_blk[0] | proc_19_output_sync_blk[0]);
    assign proc_19_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_18_U0.inter_strm_18_blk_n);
    assign proc_19_data_PIPO_blk[1] = 1'b0;
    assign proc_19_start_FIFO_blk[1] = 1'b0 | (~start_for_stencil_stage_19_U0_U.if_full_n & stencil_stage_18_U0.ap_start & ~stencil_stage_18_U0.real_start & (trans_in_cnt_18 == trans_out_cnt_18) & ~start_for_stencil_stage_19_U0_U.if_read);
    ...
    // Process: stencil_stage_19_U0
    top_kernel_hls_deadlock_detect_unit #(33, 20, 2, 2) top_kernel_hls_deadlock_detect_unit_20 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_20_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_19_U0.inter_strm_18_blk_n);
    assign proc_20_data_PIPO_blk[0] = 1'b0;
    assign proc_20_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_19_U0_U.if_empty_n & stencil_stage_19_U0.ap_idle & ~start_for_stencil_stage_19_U0_U.if_write);
    assign proc_20_TLF_FIFO_blk[0] = 1'b0;
    assign proc_20_input_sync_blk[0] = 1'b0;
    assign proc_20_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_20[0] = dl_detect_out ? proc_dep_vld_vec_20_reg[0] : (proc_20_data_FIFO_blk[0] | proc_20_data_PIPO_blk[0] | proc_20_start_FIFO_blk[0] | proc_20_TLF_FIFO_blk[0] | proc_20_input_sync_blk[0] | proc_20_output_sync_blk[0]);
    assign proc_20_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_19_U0.inter_strm_19_blk_n);
    assign proc_20_data_PIPO_blk[1] = 1'b0;
    assign proc_20_start_FIFO_blk[1] = 1'b0 | (~start_for_stencil_stage_20_U0_U.if_full_n & stencil_stage_19_U0.ap_start & ~stencil_stage_19_U0.real_start & (trans_in_cnt_19 == trans_out_cnt_19) & ~start_for_stencil_stage_20_U0_U.if_read);
    ...
    // Process: stencil_stage_20_U0
    top_kernel_hls_deadlock_detect_unit #(33, 21, 2, 2) top_kernel_hls_deadlock_detect_unit_21 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_21_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_20_U0.inter_strm_19_blk_n);
    assign proc_21_data_PIPO_blk[0] = 1'b0;
    assign proc_21_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_20_U0_U.if_empty_n & stencil_stage_20_U0.ap_idle & ~start_for_stencil_stage_20_U0_U.if_write);
    ...
    assign proc_21_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_20_U0.inter_strm_20_blk_n);
    assign proc_21_data_PIPO_blk[1] = 1'b0;
    assign proc_21_start_FIFO_blk[1] = 1'b0 | (~start_for_stencil_stage_21_U0_U.if_full_n & stencil_stage_20_U0.ap_start & ~stencil_stage_20_U0.real_start & (trans_in_cnt_20 == trans_out_cnt_20) & ~start_for_stencil_stage_21_U0_U.if_read);
    ...
    // Process: stencil_stage_21_U0
    top_kernel_hls_deadlock_detect_unit #(33, 22, 2, 2) top_kernel_hls_deadlock_detect_unit_22 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_22_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_21_U0.inter_strm_20_blk_n);
    assign proc_22_data_PIPO_blk[0] = 1'b0;
    assign proc_22_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_21_U0_U.if_empty_n & stencil_stage_21_U0.ap_idle & ~start_for_stencil_stage_21_U0_U.if_write);
    ...
    assign proc_22_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_21_U0.inter_strm_21_blk_n);
    assign proc_22_data_PIPO_blk[1] = 1'b0;
    assign proc_22_start_FIFO_blk[1] = 1'b0 | (~start_for_stencil_stage_22_U0_U.if_full_n & stencil_stage_21_U0.ap_start & ~stencil_stage_21_U0.real_start & (trans_in_cnt_21 == trans_out_cnt_21) & ~start_for_stencil_stage_22_U0_U.if_read);
    ...
    // Process: stencil_stage_22_U0
    top_kernel_hls_deadlock_detect_unit #(33, 23, 2, 2) top_kernel_hls_deadlock_detect_unit_23 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_23_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_22_U0.inter_strm_21_blk_n);
    assign proc_23_data_PIPO_blk[0] = 1'b0;
    assign proc_23_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_22_U0_U.if_empty_n & stencil_stage_22_U0.ap_idle & ~start_for_stencil_stage_22_U0_U.if_write);
    ...
    assign proc_23_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_22_U0.inter_strm_22_blk_n);
    assign proc_23_data_PIPO_blk[1] = 1'b0;
    assign proc_23_start_FIFO_blk[1] = 1'b0 | (~start_for_stencil_stage_23_U0_U.if_full_n & stencil_stage_22_U0.ap_start & ~stencil_stage_22_U0.real_start & (trans_in_cnt_22 == trans_out_cnt_22) & ~start_for_stencil_stage_23_U0_U.if_read);
    ...
    // Process: stencil_stage_23_U0
    top_kernel_hls_deadlock_detect_unit #(33, 24, 2, 2) top_kernel_hls_deadlock_detect_unit_24 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_24_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_23_U0.inter_strm_22_blk_n);
    assign proc_24_data_PIPO_blk[0] = 1'b0;
    assign proc_24_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_23_U0_U.if_empty_n & stencil_stage_23_U0.ap_idle & ~start_for_stencil_stage_23_U0_U.if_write);
    ...
    assign proc_24_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_23_U0.inter_strm_23_blk_n);
    assign proc_24_data_PIPO_blk[1] = 1'b0;
    assign proc_24_start_FIFO_blk[1] = 1'b0 | (~start_for_stencil_stage_24_U0_U.if_full_n & stencil_stage_23_U0.ap_start & ~stencil_stage_23_U0.real_start & (trans_in_cnt_23 == trans_out_cnt_23) & ~start_for_stencil_stage_24_U0_U.if_read);
    ...
    // Process: stencil_stage_24_U0
    top_kernel_hls_deadlock_detect_unit #(33, 25, 2, 2) top_kernel_hls_deadlock_detect_unit_25 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_25_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_24_U0.inter_strm_23_blk_n);
    assign proc_25_data_PIPO_blk[0] = 1'b0;
    assign proc_25_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_24_U0_U.if_empty_n & stencil_stage_24_U0.ap_idle & ~start_for_stencil_stage_24_U0_U.if_write);
    ...
    assign proc_25_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_24_U0.inter_strm_24_blk_n);
    assign proc_25_data_PIPO_blk[1] = 1'b0;
    assign proc_25_start_FIFO_blk[1] = 1'b0 | (~start_for_stencil_stage_25_U0_U.if_full_n & stencil_stage_24_U0.ap_start & ~stencil_stage_24_U0.real_start & (trans_in_cnt_24 == trans_out_cnt_24) & ~start_for_stencil_stage_25_U0_U.if_read);
    ...
    // Process: stencil_stage_25_U0
    top_kernel_hls_deadlock_detect_unit #(33, 26, 2, 2) top_kernel_hls_deadlock_detect_unit_26 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_26_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_25_U0.inter_strm_24_blk_n);
    assign proc_26_data_PIPO_blk[0] = 1'b0;
    assign proc_26_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_25_U0_U.if_empty_n & stencil_stage_25_U0.ap_idle & ~start_for_stencil_stage_25_U0_U.if_write);
    ...
    assign proc_26_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_25_U0.inter_strm_25_blk_n);
    assign proc_26_data_PIPO_blk[1] = 1'b0;
    assign proc_26_start_FIFO_blk[1] = 1'b0 | (~start_for_stencil_stage_26_U0_U.if_full_n & stencil_stage_25_U0.ap_start & ~stencil_stage_25_U0.real_start & (trans_in_cnt_25 == trans_out_cnt_25) & ~start_for_stencil_stage_26_U0_U.if_read);
    ...
    // Process: stencil_stage_26_U0
    top_kernel_hls_deadlock_detect_unit #(33, 27, 2, 2) top_kernel_hls_deadlock_detect_unit_27 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_27_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_26_U0.inter_strm_25_blk_n);
    assign proc_27_data_PIPO_blk[0] = 1'b0;
    assign proc_27_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_26_U0_U.if_empty_n & stencil_stage_26_U0.ap_idle & ~start_for_stencil_stage_26_U0_U.if_write);
    ...
    assign proc_27_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_26_U0.inter_strm_26_blk_n);
    assign proc_27_data_PIPO_blk[1] = 1'b0;
    assign proc_27_start_FIFO_blk[1] = 1'b0 | (~start_for_stencil_stage_27_U0_U.if_full_n & stencil_stage_26_U0.ap_start & ~stencil_stage_26_U0.real_start & (trans_in_cnt_26 == trans_out_cnt_26) & ~start_for_stencil_stage_27_U0_U.if_read);
    ...
    // Process: stencil_stage_27_U0
    top_kernel_hls_deadlock_detect_unit #(33, 28, 2, 2) top_kernel_hls_deadlock_detect_unit_28 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_28_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_27_U0.inter_strm_26_blk_n);
    assign proc_28_data_PIPO_blk[0] = 1'b0;
    assign proc_28_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_27_U0_U.if_empty_n & stencil_stage_27_U0.ap_idle & ~start_for_stencil_stage_27_U0_U.if_write);
    ...
    assign proc_28_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_27_U0.inter_strm_27_blk_n);
    assign proc_28_data_PIPO_blk[1] = 1'b0;
    assign proc_28_start_FIFO_blk[1] = 1'b0 | (~start_for_stencil_stage_28_U0_U.if_full_n & stencil_stage_27_U0.ap_start & ~stencil_stage_27_U0.real_start & (trans_in_cnt_27 == trans_out_cnt_27) & ~start_for_stencil_stage_28_U0_U.if_read);
    ...
    // Process: stencil_stage_28_U0
    top_kernel_hls_deadlock_detect_unit #(33, 29, 2, 2) top_kernel_hls_deadlock_detect_unit_29 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_29_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_28_U0.inter_strm_27_blk_n);
    assign proc_29_data_PIPO_blk[0] = 1'b0;
    assign proc_29_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_28_U0_U.if_empty_n & stencil_stage_28_U0.ap_idle & ~start_for_stencil_stage_28_U0_U.if_write);
    ...
    assign proc_29_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_28_U0.inter_strm_28_blk_n);
    assign proc_29_data_PIPO_blk[1] = 1'b0;
    assign proc_29_start_FIFO_blk[1] = 1'b0 | (~start_for_stencil_stage_29_U0_U.if_full_n & stencil_stage_28_U0.ap_start & ~stencil_stage_28_U0.real_start & (trans_in_cnt_28 == trans_out_cnt_28) & ~start_for_stencil_stage_29_U0_U.if_read);
    ...
    // Process: stencil_stage_29_U0
    top_kernel_hls_deadlock_detect_unit #(33, 30, 2, 2) top_kernel_hls_deadlock_detect_unit_30 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_30_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_29_U0.inter_strm_28_blk_n);
    assign proc_30_data_PIPO_blk[0] = 1'b0;
    assign proc_30_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_29_U0_U.if_empty_n & stencil_stage_29_U0.ap_idle & ~start_for_stencil_stage_29_U0_U.if_write);
    ...
    assign proc_30_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_29_U0.inter_strm_29_blk_n);
    assign proc_30_data_PIPO_blk[1] = 1'b0;
    assign proc_30_start_FIFO_blk[1] = 1'b0 | (~start_for_stencil_stage_U0_U.if_full_n & stencil_stage_29_U0.ap_start & ~stencil_stage_29_U0.real_start & (trans_in_cnt_29 == trans_out_cnt_29) & ~start_for_stencil_stage_U0_U.if_read);
    ...
    // Process: stencil_stage_U0
    top_kernel_hls_deadlock_detect_unit #(33, 31, 2, 2) top_kernel_hls_deadlock_detect_unit_31 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_31_data_FIFO_blk[0] = 1'b0 | (~stencil_stage_U0.inter_strm_29_blk_n);
    assign proc_31_data_PIPO_blk[0] = 1'b0;
    assign proc_31_start_FIFO_blk[0] = 1'b0 | (~start_for_stencil_stage_U0_U.if_empty_n & stencil_stage_U0.ap_idle & ~start_for_stencil_stage_U0_U.if_write);
    ...
    assign proc_31_data_FIFO_blk[1] = 1'b0 | (~stencil_stage_U0.inter_strm_30_blk_n);
    ...
    top_kernel_hls_deadlock_detect_unit #(33, 32, 2, 2) top_kernel_hls_deadlock_detect_unit_32 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_32_data_FIFO_blk[0] = 1'b0 | (~write_output_U0.inter_strm_30_blk_n);
    ...
    assign proc_32_data_FIFO_blk[1] = 1'b0 | (~write_output_U0.out_r_blk_n);
    assign proc_32_data_PIPO_blk[1] = 1'b0;
    assign proc_32_start_FIFO_blk[1] = 1'b0 | (~start_for_write_output_U0_U.if_empty_n & write_output_U0.ap_idle & ~start_for_write_output_U0_U.if_write);
