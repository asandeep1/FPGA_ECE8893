...
set portList { 
	...
	{ out_r_c_num_data_valid sc_in sc_lv 4 signal 1 } 
	{ out_r_c_fifo_cap sc_in sc_lv 4 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out_r_c_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "out_r_c", "role": "num_data_valid" }} , 
 	{ "name": "out_r_c_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "out_r_c", "role": "fifo_cap" }}  ]}
...
set Spec2ImplPortList { 
	...
	out_r_c { ap_fifo {  { out_r_c_din fifo_data_in 1 64 }  { out_r_c_full_n fifo_status 0 1 }  { out_r_c_write fifo_port_we 1 1 }  { out_r_c_num_data_valid fifo_status_num_data_valid 0 4 }  { out_r_c_fifo_cap fifo_update 0 4 } } }
}
