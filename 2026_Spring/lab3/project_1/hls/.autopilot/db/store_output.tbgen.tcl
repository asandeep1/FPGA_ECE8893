...
set C_modelArgList {
	...
	{ s_out int 20 regular {fifo 0 volatile } {global 0}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "s_out", "interface" : "fifo", "bitwidth" : 20, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ s_out_dout sc_in sc_lv 20 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "s_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":20, "type": "signal", "bundle":{"name": "s_out", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	...
	s_out { ap_fifo {  { s_out_dout fifo_data_in 0 20 }  { s_out_empty_n fifo_status 0 1 }  { s_out_read fifo_port_we 1 1 }  { s_out_num_data_valid fifo_status_num_data_valid 0 3 }  { s_out_fifo_cap fifo_update 0 3 } } }
}
