...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_sa_in \
    op interface \
    ports { sa_in_din { O 512 vector } sa_in_full_n { I 1 bit } sa_in_write { O 1 bit } sa_in_num_data_valid { I 3 vector } sa_in_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_sb_in \
    op interface \
    ports { sb_in_din { O 512 vector } sb_in_full_n { I 1 bit } sb_in_write { O 1 bit } sb_in_num_data_valid { I 3 vector } sb_in_fifo_cap { I 3 vector } } \
} "
}
