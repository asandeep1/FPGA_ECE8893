...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_out_r \
    op interface \
    ports { out_r_dout { I 64 vector } out_r_empty_n { I 1 bit } out_r_read { O 1 bit } out_r_num_data_valid { I 4 vector } out_r_fifo_cap { I 4 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_sa_post \
    op interface \
    ports { sa_post_dout { I 512 vector } sa_post_empty_n { I 1 bit } sa_post_read { O 1 bit } sa_post_num_data_valid { I 3 vector } sa_post_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_sb_post \
    op interface \
    ports { sb_post_dout { I 512 vector } sb_post_empty_n { I 1 bit } sb_post_read { O 1 bit } sb_post_num_data_valid { I 3 vector } sb_post_fifo_cap { I 3 vector } } \
} "
}
