...
set cdfgNum 9
set C_modelName {store_dual}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem1 int 1024 regular {axi_master 1}  }
	{ out_r int 64 regular {fifo 0}  }
	{ sa_post int 512 regular {fifo 0 volatile } {global 0}  }
	{ sb_post int 512 regular {fifo 0 volatile } {global 0}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 1024, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "sa_post", "interface" : "fifo", "bitwidth" : 512, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "sb_post", "interface" : "fifo", "bitwidth" : 512, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ out_r_num_data_valid sc_in sc_lv 4 signal 1 } 
	{ out_r_fifo_cap sc_in sc_lv 4 signal 1 } 
	...
	{ sa_post_dout sc_in sc_lv 512 signal 2 } 
	{ sa_post_empty_n sc_in sc_logic 1 signal 2 } 
	{ sa_post_read sc_out sc_logic 1 signal 2 } 
	{ sa_post_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ sa_post_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ sb_post_dout sc_in sc_lv 512 signal 3 } 
	{ sb_post_empty_n sc_in sc_logic 1 signal 3 } 
	{ sb_post_read sc_out sc_logic 1 signal 3 } 
	{ sb_post_num_data_valid sc_in sc_lv 3 signal 3 } 
	{ sb_post_fifo_cap sc_in sc_lv 3 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sa_post_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "sa_post", "role": "dout" }} , 
 	{ "name": "sa_post_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "sa_post", "role": "empty_n" }} , 
 	{ "name": "sa_post_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "sa_post", "role": "read" }} , 
 	{ "name": "sa_post_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "sa_post", "role": "num_data_valid" }} , 
 	{ "name": "sa_post_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "sa_post", "role": "fifo_cap" }} , 
 	{ "name": "sb_post_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "sb_post", "role": "dout" }} , 
 	{ "name": "sb_post_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "sb_post", "role": "empty_n" }} , 
 	{ "name": "sb_post_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "sb_post", "role": "read" }} , 
 	{ "name": "sb_post_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "sb_post", "role": "num_data_valid" }} , 
 	{ "name": "sb_post_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "sb_post", "role": "fifo_cap" }}  ]}

set ArgLastReadFirstWriteLatency {
	store_dual {
		gmem1 {Type O LastRead 4 FirstWrite 3}
		out_r {Type I LastRead 1 FirstWrite -1}
		sa_post {Type I LastRead 2 FirstWrite -1}
		sb_post {Type I LastRead 2 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	...
	sa_post { ap_fifo {  { sa_post_dout fifo_data_in 0 512 }  { sa_post_empty_n fifo_status 0 1 }  { sa_post_read fifo_port_we 1 1 }  { sa_post_num_data_valid fifo_status_num_data_valid 0 3 }  { sa_post_fifo_cap fifo_update 0 3 } } }
	sb_post { ap_fifo {  { sb_post_dout fifo_data_in 0 512 }  { sb_post_empty_n fifo_status 0 1 }  { sb_post_read fifo_port_we 1 1 }  { sb_post_num_data_valid fifo_status_num_data_valid 0 3 }  { sb_post_fifo_cap fifo_update 0 3 } } }
}
