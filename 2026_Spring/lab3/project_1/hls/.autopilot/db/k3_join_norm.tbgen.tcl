...
set C_modelArgList {
	...
	{ s1 int 20 regular {fifo 0 volatile } {global 0}  }
	{ s3 int 20 regular {fifo 1 volatile } {global 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "s_stats", "interface" : "fifo", "bitwidth" : 28, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "s1", "interface" : "fifo", "bitwidth" : 20, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "s3", "interface" : "fifo", "bitwidth" : 20, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ s1_dout sc_in sc_lv 20 signal 1 } 
	{ s1_empty_n sc_in sc_logic 1 signal 1 } 
	{ s1_read sc_out sc_logic 1 signal 1 } 
	{ s1_num_data_valid sc_in sc_lv 9 signal 1 } 
	{ s1_fifo_cap sc_in sc_lv 9 signal 1 } 
	{ s3_din sc_out sc_lv 20 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "s1_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":20, "type": "signal", "bundle":{"name": "s1", "role": "dout" }} , 
 	...
 	{ "name": "s3_din", "direction": "out", "datatype": "sc_lv", "bitwidth":20, "type": "signal", "bundle":{"name": "s3", "role": "din" }} , 
...
set ArgLastReadFirstWriteLatency {
	k3_join_norm {
		...
		s3 {Type O LastRead -1 FirstWrite 3}}}
...
set Spec2ImplPortList { 
	...
	s1 { ap_fifo {  { s1_dout fifo_data_in 0 20 }  { s1_empty_n fifo_status 0 1 }  { s1_read fifo_port_we 1 1 }  { s1_num_data_valid fifo_status_num_data_valid 0 9 }  { s1_fifo_cap fifo_update 0 9 } } }
	s3 { ap_fifo {  { s3_din fifo_data_in 1 20 }  { s3_full_n fifo_status 0 1 }  { s3_write fifo_port_we 1 1 }  { s3_num_data_valid fifo_status_num_data_valid 0 32 }  { s3_fifo_cap fifo_update 0 32 } } }
}
