set SynModuleInfo {
  ...
  {SRCNAME super_kernel_32 MODELNAME super_kernel_32 RTLNAME top_kernel_super_kernel_32
    SUBMODULES {
      {MODELNAME top_kernel_mul_30s_25ns_54_4_1 RTLNAME top_kernel_mul_30s_25ns_54_4_1 BINDTYPE op TYPE mul IMPL dsp LATENCY 3 ALLOW_PRAGMA 1}
  ...
  {SRCNAME k2_stats_dual MODELNAME k2_stats_dual RTLNAME top_kernel_k2_stats_dual
    SUBMODULES {
      {MODELNAME top_kernel_flow_control_loop_delay_pipe RTLNAME top_kernel_flow_control_loop_delay_pipe BINDTYPE interface TYPE internal_upc_flow_control INSTNAME top_kernel_flow_control_loop_delay_pipe_U}
    }
  }
  {SRCNAME k3_dual_norm MODELNAME k3_dual_norm RTLNAME top_kernel_k3_dual_norm
    SUBMODULES {
      {MODELNAME top_kernel_mul_34s_30s_64_4_1 RTLNAME top_kernel_mul_34s_30s_64_4_1 BINDTYPE op TYPE mul IMPL dsp LATENCY 3 ALLOW_PRAGMA 1}
  ...
  {SRCNAME k4_dual_post MODELNAME k4_dual_post RTLNAME top_kernel_k4_dual_post
    SUBMODULES {
      {MODELNAME top_kernel_mul_30s_26ns_55_4_1 RTLNAME top_kernel_mul_30s_26ns_55_4_1 BINDTYPE op TYPE mul IMPL dsp LATENCY 3 ALLOW_PRAGMA 1}
    }
  }
  ...
  {SRCNAME top_kernel MODELNAME top_kernel RTLNAME top_kernel IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME top_kernel_fifo_w512_d3_A RTLNAME top_kernel_fifo_w512_d3_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME sa_in_U}
      {MODELNAME top_kernel_fifo_w512_d3_A RTLNAME top_kernel_fifo_w512_d3_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME sb_in_U}
      ...
      {MODELNAME top_kernel_fifo_w512_d1024_A RTLNAME top_kernel_fifo_w512_d1024_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME sa_join_U}
      ...
      {MODELNAME top_kernel_fifo_w512_d1024_A RTLNAME top_kernel_fifo_w512_d1024_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME sb_join_U}
