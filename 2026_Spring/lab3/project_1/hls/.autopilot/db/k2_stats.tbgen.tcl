...
set C_modelArgList {
	...
	{ s0_b int 512 regular {fifo 0 volatile } {global 0}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "s_stats", "interface" : "fifo", "bitwidth" : 28, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "s0_b", "interface" : "fifo", "bitwidth" : 512, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ s0_b_dout sc_in sc_lv 512 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "s0_b_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "s0_b", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	...
	s0_b { ap_fifo {  { s0_b_dout fifo_data_in 0 512 }  { s0_b_empty_n fifo_status 0 1 }  { s0_b_read fifo_port_we 1 1 }  { s0_b_num_data_valid fifo_status_num_data_valid 0 3 }  { s0_b_fifo_cap fifo_update 0 3 } } }
}
