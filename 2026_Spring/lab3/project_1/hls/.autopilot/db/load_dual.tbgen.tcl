...
set cdfgNum 9
set C_modelName {load_dual}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem0 int 1024 regular {axi_master 0}  }
	{ in_r int 64 regular  }
	{ sa_in int 512 regular {fifo 1 volatile } {global 1}  }
	{ sb_in int 512 regular {fifo 1 volatile } {global 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 1024, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in_r","offset": { "type": "dynamic","port_name": "in_r","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "sa_in", "interface" : "fifo", "bitwidth" : 512, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "sb_in", "interface" : "fifo", "bitwidth" : 512, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ sa_in_din sc_out sc_lv 512 signal 2 } 
	{ sa_in_full_n sc_in sc_logic 1 signal 2 } 
	{ sa_in_write sc_out sc_logic 1 signal 2 } 
	{ sa_in_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ sa_in_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ sb_in_din sc_out sc_lv 512 signal 3 } 
	{ sb_in_full_n sc_in sc_logic 1 signal 3 } 
	{ sb_in_write sc_out sc_logic 1 signal 3 } 
	{ sb_in_num_data_valid sc_in sc_lv 3 signal 3 } 
	{ sb_in_fifo_cap sc_in sc_lv 3 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sa_in_din", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "sa_in", "role": "din" }} , 
 	{ "name": "sa_in_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "sa_in", "role": "full_n" }} , 
 	{ "name": "sa_in_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "sa_in", "role": "write" }} , 
 	...
 	{ "name": "sb_in_din", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "sb_in", "role": "din" }} , 
 	{ "name": "sb_in_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "sb_in", "role": "full_n" }} , 
 	{ "name": "sb_in_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "sb_in", "role": "write" }} , 
...
set ArgLastReadFirstWriteLatency {
	load_dual {
		...
		sa_in {Type O LastRead -1 FirstWrite 10}
		sb_in {Type O LastRead -1 FirstWrite 10}}}
...
set Spec2ImplPortList { 
	...
	sa_in { ap_fifo {  { sa_in_din fifo_data_in 1 512 }  { sa_in_full_n fifo_status 0 1 }  { sa_in_write fifo_port_we 1 1 }  { sa_in_num_data_valid fifo_status_num_data_valid 0 3 }  { sa_in_fifo_cap fifo_update 0 3 } } }
	sb_in { ap_fifo {  { sb_in_din fifo_data_in 1 512 }  { sb_in_full_n fifo_status 0 1 }  { sb_in_write fifo_port_we 1 1 }  { sb_in_num_data_valid fifo_status_num_data_valid 0 3 }  { sb_in_fifo_cap fifo_update 0 3 } } }
}
