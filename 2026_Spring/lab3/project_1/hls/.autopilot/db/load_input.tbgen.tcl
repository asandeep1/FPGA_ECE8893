...
set C_modelArgList {
	...
	{ in_r int 64 regular  }
	{ s_in int 20 regular {fifo 1 volatile } {global 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in_r","offset": { "type": "dynamic","port_name": "in_r","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "s_in", "interface" : "fifo", "bitwidth" : 20, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ s_in_din sc_out sc_lv 20 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "s_in_din", "direction": "out", "datatype": "sc_lv", "bitwidth":20, "type": "signal", "bundle":{"name": "s_in", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	s_in { ap_fifo {  { s_in_din fifo_data_in 1 20 }  { s_in_full_n fifo_status 0 1 }  { s_in_write fifo_port_we 1 1 }  { s_in_num_data_valid fifo_status_num_data_valid 0 3 }  { s_in_fifo_cap fifo_update 0 3 } } }
}
