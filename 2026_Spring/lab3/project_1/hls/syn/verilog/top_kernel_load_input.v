...
reg   [0:0] icmp_ln123_reg_162;
reg    ap_block_pp0_stage0_11001;
wire   [19:0] trunc_ln125_fu_146_p1;
reg   [19:0] trunc_ln125_reg_172;
wire    ap_loop_init;
wire    ap_block_pp0_stage0;
wire  signed [63:0] sext_ln123_fu_135_p1;
reg   [15:0] i1_fu_60;
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln123_fu_115_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    ap_condition_333 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln123_reg_162 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001));
end
...
assign icmp_ln123_fu_115_p2 = ((ap_sig_allocacmp_i1_load == 16'd65535) ? 1'b1 : 1'b0);

assign m_axi_gmem0_0_ARADDR = sext_ln123_fu_135_p1;
...
assign s_in_din = trunc_ln125_reg_172;

assign sext_ln123_fu_135_p1 = $signed(trunc_ln_fu_126_p4);

assign start_out = real_start;

assign trunc_ln125_fu_146_p1 = m_axi_gmem0_0_RDATA[19:0];

assign trunc_ln_fu_126_p4 = {{in_read_reg_157[63:2]}};

endmodule //top_kernel_load_input
