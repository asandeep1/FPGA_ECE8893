...
module sv_module_top;
    ...
    axi_if #(64,128,8,3,1)  axi_gmem1_if (.clk  (apatb_top_kernel_top.AESL_clock), .rst(apatb_top_kernel_top.AESL_reset));
    ...
    initial begin
        uvm_config_db #( virtual axi_if#(64,128,8,3,1) )::set(null, "uvm_test_top.top_env.axi_master_gmem1.*", "vif", axi_gmem1_if);
    end
