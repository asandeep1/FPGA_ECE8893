...
set genomeRtd $env(RT_TMP)/3D0F3420.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {top_kernel_super_kernel_32__GB0}]"
...
set genomeName [subst -nocommands -novariables {top_kernel_super_kernel_32__GB0}]
