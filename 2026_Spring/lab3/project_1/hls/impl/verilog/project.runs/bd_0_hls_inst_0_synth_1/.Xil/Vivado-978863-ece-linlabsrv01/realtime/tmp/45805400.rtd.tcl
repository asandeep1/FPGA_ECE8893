...
set genomeRtd $env(RT_TMP)/45805400.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {top_kernel__GCB2}]"
...
set genomeName [subst -nocommands -novariables {top_kernel__GCB2}]
