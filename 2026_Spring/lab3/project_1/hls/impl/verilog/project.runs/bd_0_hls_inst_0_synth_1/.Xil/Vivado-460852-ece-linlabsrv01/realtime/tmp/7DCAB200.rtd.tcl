...
set genomeRtd $env(RT_TMP)/7DCAB200.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {top_kernel_GT0__1}]"
...
set genomeName [subst -nocommands -novariables {top_kernel_GT0__1}]
