...
reg [15:0] trans_in_cnt_1;// for process k0_preprocess_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_1 <= 16'h0;
    end
    else if (k0_preprocess_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_1;// for process k0_preprocess_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_1 <= 16'h0;
    end
    else if (k0_preprocess_U0.ap_done == 1'b1 && k0_preprocess_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_2;// for process k_split_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_2 <= 16'h0;
    end
    else if (k_split_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_2;// for process k_split_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_2 <= 16'h0;
    end
    else if (k_split_U0.ap_done == 1'b1 && k_split_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_3;// for process k1_transform_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_3 <= 16'h0;
    end
    else if (k1_transform_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_3;// for process k1_transform_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_3 <= 16'h0;
    end
    else if (k1_transform_U0.ap_done == 1'b1 && k1_transform_U0.ap_continue == 1'b1) begin
...
reg [15:0] trans_in_cnt_4;// for process k3_join_norm_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_4 <= 16'h0;
    end
    else if (k3_join_norm_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_4;// for process k3_join_norm_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_4 <= 16'h0;
    end
    else if (k3_join_norm_U0.ap_done == 1'b1 && k3_join_norm_U0.ap_continue == 1'b1) begin
...
always @(negedge dl_reset or posedge dl_clock) begin
    ...
    top_kernel_hls_deadlock_detect_unit #(9, 0, 2, 2) top_kernel_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    // Process: k0_preprocess_U0
    top_kernel_hls_deadlock_detect_unit #(9, 2, 2, 2) top_kernel_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~k0_preprocess_U0.s_in_blk_n);
    assign proc_2_data_PIPO_blk[0] = 1'b0;
    assign proc_2_start_FIFO_blk[0] = 1'b0 | (~start_for_k0_preprocess_U0_U.if_empty_n & k0_preprocess_U0.ap_idle & ~start_for_k0_preprocess_U0_U.if_write);
    assign proc_2_TLF_FIFO_blk[0] = 1'b0;
    assign proc_2_input_sync_blk[0] = 1'b0;
    assign proc_2_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_2[0] = dl_detect_out ? proc_dep_vld_vec_2_reg[0] : (proc_2_data_FIFO_blk[0] | proc_2_data_PIPO_blk[0] | proc_2_start_FIFO_blk[0] | proc_2_TLF_FIFO_blk[0] | proc_2_input_sync_blk[0] | proc_2_output_sync_blk[0]);
    assign proc_2_data_FIFO_blk[1] = 1'b0 | (~k0_preprocess_U0.s0_blk_n);
    assign proc_2_data_PIPO_blk[1] = 1'b0;
    assign proc_2_start_FIFO_blk[1] = 1'b0 | (~start_for_k_split_U0_U.if_full_n & k0_preprocess_U0.ap_start & ~k0_preprocess_U0.real_start & (trans_in_cnt_1 == trans_out_cnt_1) & ~start_for_k_split_U0_U.if_read);
    ...
    // Process: k_split_U0
    top_kernel_hls_deadlock_detect_unit #(9, 3, 3, 3) top_kernel_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~k_split_U0.s0_blk_n);
    assign proc_3_data_PIPO_blk[0] = 1'b0;
    assign proc_3_start_FIFO_blk[0] = 1'b0 | (~start_for_k_split_U0_U.if_empty_n & k_split_U0.ap_idle & ~start_for_k_split_U0_U.if_write);
    assign proc_3_TLF_FIFO_blk[0] = 1'b0;
    assign proc_3_input_sync_blk[0] = 1'b0;
    assign proc_3_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_3[0] = dl_detect_out ? proc_dep_vld_vec_3_reg[0] : (proc_3_data_FIFO_blk[0] | proc_3_data_PIPO_blk[0] | proc_3_start_FIFO_blk[0] | proc_3_TLF_FIFO_blk[0] | proc_3_input_sync_blk[0] | proc_3_output_sync_blk[0]);
    assign proc_3_data_FIFO_blk[1] = 1'b0 | (~k_split_U0.s0_a_blk_n);
    assign proc_3_data_PIPO_blk[1] = 1'b0;
    assign proc_3_start_FIFO_blk[1] = 1'b0 | (~start_for_k1_transform_U0_U.if_full_n & k_split_U0.ap_start & ~k_split_U0.real_start & (trans_in_cnt_2 == trans_out_cnt_2) & ~start_for_k1_transform_U0_U.if_read);
    assign proc_3_TLF_FIFO_blk[1] = 1'b0;
    assign proc_3_input_sync_blk[1] = 1'b0;
    assign proc_3_output_sync_blk[1] = 1'b0;
    assign proc_dep_vld_vec_3[1] = dl_detect_out ? proc_dep_vld_vec_3_reg[1] : (proc_3_data_FIFO_blk[1] | proc_3_data_PIPO_blk[1] | proc_3_start_FIFO_blk[1] | proc_3_TLF_FIFO_blk[1] | proc_3_input_sync_blk[1] | proc_3_output_sync_blk[1]);
    assign proc_3_data_FIFO_blk[2] = 1'b0 | (~k_split_U0.s0_b_blk_n);
    assign proc_3_data_PIPO_blk[2] = 1'b0;
    assign proc_3_start_FIFO_blk[2] = 1'b0 | (~start_for_k2_stats_U0_U.if_full_n & k_split_U0.ap_start & ~k_split_U0.real_start & (trans_in_cnt_2 == trans_out_cnt_2) & ~start_for_k2_stats_U0_U.if_read);
    ...
    // Process: k1_transform_U0
    top_kernel_hls_deadlock_detect_unit #(9, 4, 2, 2) top_kernel_hls_deadlock_detect_unit_4 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_4_data_FIFO_blk[0] = 1'b0 | (~k1_transform_U0.s0_a_blk_n);
    assign proc_4_data_PIPO_blk[0] = 1'b0;
    assign proc_4_start_FIFO_blk[0] = 1'b0 | (~start_for_k1_transform_U0_U.if_empty_n & k1_transform_U0.ap_idle & ~start_for_k1_transform_U0_U.if_write);
    assign proc_4_TLF_FIFO_blk[0] = 1'b0;
    assign proc_4_input_sync_blk[0] = 1'b0;
    assign proc_4_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_4[0] = dl_detect_out ? proc_dep_vld_vec_4_reg[0] : (proc_4_data_FIFO_blk[0] | proc_4_data_PIPO_blk[0] | proc_4_start_FIFO_blk[0] | proc_4_TLF_FIFO_blk[0] | proc_4_input_sync_blk[0] | proc_4_output_sync_blk[0]);
    assign proc_4_data_FIFO_blk[1] = 1'b0 | (~k1_transform_U0.s1_blk_n);
    assign proc_4_data_PIPO_blk[1] = 1'b0;
    assign proc_4_start_FIFO_blk[1] = 1'b0 | (~start_for_k3_join_norm_U0_U.if_full_n & k1_transform_U0.ap_start & ~k1_transform_U0.real_start & (trans_in_cnt_3 == trans_out_cnt_3) & ~start_for_k3_join_norm_U0_U.if_read);
    ...
    // Process: k2_stats_U0
    top_kernel_hls_deadlock_detect_unit #(9, 5, 2, 2) top_kernel_hls_deadlock_detect_unit_5 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_5_data_FIFO_blk[0] = 1'b0 | (~k2_stats_U0.s_stats_blk_n);
    ...
    assign proc_5_data_FIFO_blk[1] = 1'b0 | (~k2_stats_U0.s0_b_blk_n);
    assign proc_5_data_PIPO_blk[1] = 1'b0;
    assign proc_5_start_FIFO_blk[1] = 1'b0 | (~start_for_k2_stats_U0_U.if_empty_n & k2_stats_U0.ap_idle & ~start_for_k2_stats_U0_U.if_write);
    ...
    // Process: k3_join_norm_U0
    top_kernel_hls_deadlock_detect_unit #(9, 6, 3, 3) top_kernel_hls_deadlock_detect_unit_6 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_6_data_FIFO_blk[0] = 1'b0 | (~k3_join_norm_U0.s_stats_blk_n);
    ...
    assign proc_6_data_FIFO_blk[1] = 1'b0 | (~k3_join_norm_U0.s1_blk_n);
    assign proc_6_data_PIPO_blk[1] = 1'b0;
    assign proc_6_start_FIFO_blk[1] = 1'b0 | (~start_for_k3_join_norm_U0_U.if_empty_n & k3_join_norm_U0.ap_idle & ~start_for_k3_join_norm_U0_U.if_write);
    assign proc_6_TLF_FIFO_blk[1] = 1'b0;
    assign proc_6_input_sync_blk[1] = 1'b0;
    assign proc_6_output_sync_blk[1] = 1'b0;
    assign proc_dep_vld_vec_6[1] = dl_detect_out ? proc_dep_vld_vec_6_reg[1] : (proc_6_data_FIFO_blk[1] | proc_6_data_PIPO_blk[1] | proc_6_start_FIFO_blk[1] | proc_6_TLF_FIFO_blk[1] | proc_6_input_sync_blk[1] | proc_6_output_sync_blk[1]);
    assign proc_6_data_FIFO_blk[2] = 1'b0 | (~k3_join_norm_U0.s3_blk_n);
    assign proc_6_data_PIPO_blk[2] = 1'b0;
    assign proc_6_start_FIFO_blk[2] = 1'b0 | (~start_for_k4_postprocess_U0_U.if_full_n & k3_join_norm_U0.ap_start & ~k3_join_norm_U0.real_start & (trans_in_cnt_4 == trans_out_cnt_4) & ~start_for_k4_postprocess_U0_U.if_read);
    ...
    // Process: k4_postprocess_U0
    top_kernel_hls_deadlock_detect_unit #(9, 7, 2, 2) top_kernel_hls_deadlock_detect_unit_7 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_7_data_FIFO_blk[0] = 1'b0 | (~k4_postprocess_U0.s3_blk_n);
    assign proc_7_data_PIPO_blk[0] = 1'b0;
    assign proc_7_start_FIFO_blk[0] = 1'b0 | (~start_for_k4_postprocess_U0_U.if_empty_n & k4_postprocess_U0.ap_idle & ~start_for_k4_postprocess_U0_U.if_write);
    assign proc_7_TLF_FIFO_blk[0] = 1'b0;
    assign proc_7_input_sync_blk[0] = 1'b0;
    assign proc_7_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_7[0] = dl_detect_out ? proc_dep_vld_vec_7_reg[0] : (proc_7_data_FIFO_blk[0] | proc_7_data_PIPO_blk[0] | proc_7_start_FIFO_blk[0] | proc_7_TLF_FIFO_blk[0] | proc_7_input_sync_blk[0] | proc_7_output_sync_blk[0]);
    assign proc_7_data_FIFO_blk[1] = 1'b0 | (~k4_postprocess_U0.s_out_blk_n);
