...
module top_kernel_store_output (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln193_reg_199;
reg   [0:0] icmp_ln193_reg_199_pp0_iter7_reg;
reg    ap_block_state9_pp0_stage0_iter8_grp1;
reg    ap_block_pp0_stage0_subdone;
wire   [0:0] icmp_ln193_fu_136_p2;
...
reg   [0:0] icmp_ln193_reg_199_pp0_iter1_reg;
reg   [0:0] icmp_ln193_reg_199_pp0_iter2_reg;
reg   [0:0] icmp_ln193_reg_199_pp0_iter3_reg;
reg   [0:0] icmp_ln193_reg_199_pp0_iter4_reg;
reg   [0:0] icmp_ln193_reg_199_pp0_iter5_reg;
reg   [0:0] icmp_ln193_reg_199_pp0_iter6_reg;
reg   [61:0] trunc_ln_reg_203;
reg   [19:0] s_out_read_reg_208;
wire    ap_loop_init;
wire    ap_block_pp0_stage0;
wire  signed [63:0] sext_ln193_fu_157_p1;
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln193_fu_136_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter8 == 1'b1) & (1'b0 == ap_block_pp0_stage0_grp1) & (icmp_ln193_reg_199_pp0_iter7_reg == 1'd1))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter8 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001_grp1) & (icmp_ln193_reg_199_pp0_iter7_reg == 1'd1))) begin
...
always @ (*) begin
    ap_block_state9_pp0_stage0_iter8_grp1 = ((icmp_ln193_reg_199_pp0_iter7_reg == 1'd1) & (m_axi_gmem1_0_BVALID == 1'b0));
end
...
always @ (*) begin
    ap_condition_353 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln193_reg_199 == 1'd0));
end
...
assign icmp_ln193_fu_136_p2 = ((ap_sig_allocacmp_i1_load == 16'd65535) ? 1'b1 : 1'b0);
...
assign m_axi_gmem1_0_AWADDR = sext_ln193_fu_157_p1;
...
assign m_axi_gmem1_0_WDATA = s_out_read_reg_208;
...
assign sext_ln193_fu_157_p1 = $signed(trunc_ln_reg_203);

endmodule //top_kernel_store_output
