set moduleName load_input_wide
set isTopModule 0
...
set cdfgNum 11
set C_modelName {load_input_wide}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem0 int 512 regular {axi_master 0}  }
	{ in_r int 64 regular  }
	{ s_in int 512 regular {fifo 1 volatile } {global 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in_r","offset": { "type": "dynamic","port_name": "in_r","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "s_in", "interface" : "fifo", "bitwidth" : 512, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ s_in_din sc_out sc_lv 512 signal 2 } 
	{ s_in_full_n sc_in sc_logic 1 signal 2 } 
	{ s_in_write sc_out sc_logic 1 signal 2 } 
	{ s_in_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ s_in_fifo_cap sc_in sc_lv 3 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "s_in_din", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "s_in", "role": "din" }} , 
...
set ArgLastReadFirstWriteLatency {
	load_input_wide {
		...
		s_in {Type O LastRead -1 FirstWrite 10}}}
...
set Spec2ImplPortList { 
	...
	s_in { ap_fifo {  { s_in_din fifo_data_in 1 512 }  { s_in_full_n fifo_status 0 1 }  { s_in_write fifo_port_we 1 1 }  { s_in_num_data_valid fifo_status_num_data_valid 0 3 }  { s_in_fifo_cap fifo_update 0 3 } } }
}
