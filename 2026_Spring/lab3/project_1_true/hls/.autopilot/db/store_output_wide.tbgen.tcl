set moduleName store_output_wide
set isTopModule 0
...
set cdfgNum 11
set C_modelName {store_output_wide}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem1 int 512 regular {axi_master 1}  }
	{ out_r int 64 regular {fifo 0}  }
	{ s_out int 512 regular {fifo 0 volatile } {global 0}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "s_out", "interface" : "fifo", "bitwidth" : 512, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ s_out_dout sc_in sc_lv 512 signal 2 } 
	{ s_out_empty_n sc_in sc_logic 1 signal 2 } 
	{ s_out_read sc_out sc_logic 1 signal 2 } 
	{ s_out_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ s_out_fifo_cap sc_in sc_lv 3 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "s_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "s_out", "role": "dout" }} , 
 	...
 	{ "name": "s_out_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "s_out", "role": "num_data_valid" }} , 
 	{ "name": "s_out_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "s_out", "role": "fifo_cap" }}  ]}

set ArgLastReadFirstWriteLatency {
	store_output_wide {
		gmem1 {Type O LastRead 4 FirstWrite 3}
		out_r {Type I LastRead 1 FirstWrite -1}
		s_out {Type I LastRead 2 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	...
	s_out { ap_fifo {  { s_out_dout fifo_data_in 0 512 }  { s_out_empty_n fifo_status 0 1 }  { s_out_read fifo_port_we 1 1 }  { s_out_num_data_valid fifo_status_num_data_valid 0 3 }  { s_out_fifo_cap fifo_update 0 3 } } }
}
