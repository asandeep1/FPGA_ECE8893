...
entry:
  call fastcc void @"onebyonecpy_hls.p0a65536struct.ap_fixed<20, 6, AP_RND, AP_SAT, 0>.48"([65536 x i20]* %1, [65536 x %"struct.ap_fixed<20, 6, AP_RND, AP_SAT, 0>"]* %0)
  call fastcc void @"onebyonecpy_hls.p0a65536struct.ap_fixed<20, 6, AP_RND, AP_SAT, 0>.48"([65536 x i20]* %3, [65536 x %"struct.ap_fixed<20, 6, AP_RND, AP_SAT, 0>"]* %2)
  ret void
}
...
copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a65536struct.ap_fixed<20, 6, AP_RND, AP_SAT, 0>.44"([65536 x %"struct.ap_fixed<20, 6, AP_RND, AP_SAT, 0>"]* nonnull %dst, [65536 x i20]* %src, i64 65536)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a65536struct.ap_fixed<20, 6, AP_RND, AP_SAT, 0>.44"([65536 x %"struct.ap_fixed<20, 6, AP_RND, AP_SAT, 0>"]* "unpacked"="0" %dst, [65536 x i20]* nocapture readonly "unpacked"="1.0" %src, i64 "unpacked"="2" %num) local_unnamed_addr #4 {
entry:
  %0 = icmp eq [65536 x %"struct.ap_fixed<20, 6, AP_RND, AP_SAT, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0a65536struct.ap_fixed<20, 6, AP_RND, AP_SAT, 0>.48"([65536 x i20]* nocapture "unpacked"="0.0" %dst, [65536 x %"struct.ap_fixed<20, 6, AP_RND, AP_SAT, 0>"]* readonly "unpacked"="1" %src) unnamed_addr #3 {
entry:
  %0 = icmp eq [65536 x %"struct.ap_fixed<20, 6, AP_RND, AP_SAT, 0>"]* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a65536struct.ap_fixed<20, 6, AP_RND, AP_SAT, 0>.51"([65536 x i20]* %dst, [65536 x %"struct.ap_fixed<20, 6, AP_RND, AP_SAT, 0>"]* nonnull %src, i64 65536)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a65536struct.ap_fixed<20, 6, AP_RND, AP_SAT, 0>.51"([65536 x i20]* nocapture "unpacked"="0.0" %dst, [65536 x %"struct.ap_fixed<20, 6, AP_RND, AP_SAT, 0>"]* readonly "unpacked"="1" %src, i64 "unpacked"="2" %num) local_unnamed_addr #4 {
entry:
  %0 = icmp eq [65536 x %"struct.ap_fixed<20, 6, AP_RND, AP_SAT, 0>"]* %src, null
  br i1 %0, label %ret, label %copy
