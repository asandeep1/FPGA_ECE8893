...
void XTop_kernel_Set_in_r(XTop_kernel *InstancePtr, u64 Data) {
    ...
    XTop_kernel_WriteReg(InstancePtr->Control_BaseAddress, XTOP_KERNEL_CONTROL_ADDR_IN_R_DATA, (u32)(Data));
    XTop_kernel_WriteReg(InstancePtr->Control_BaseAddress, XTOP_KERNEL_CONTROL_ADDR_IN_R_DATA + 4, (u32)(Data >> 32));
}
...
u64 XTop_kernel_Get_in_r(XTop_kernel *InstancePtr) {
    ...
    Data = XTop_kernel_ReadReg(InstancePtr->Control_BaseAddress, XTOP_KERNEL_CONTROL_ADDR_IN_R_DATA);
    Data += (u64)XTop_kernel_ReadReg(InstancePtr->Control_BaseAddress, XTOP_KERNEL_CONTROL_ADDR_IN_R_DATA + 4) << 32;
    return Data;
}
...
void XTop_kernel_Set_out_r(XTop_kernel *InstancePtr, u64 Data) {
    ...
    XTop_kernel_WriteReg(InstancePtr->Control_BaseAddress, XTOP_KERNEL_CONTROL_ADDR_OUT_R_DATA, (u32)(Data));
    XTop_kernel_WriteReg(InstancePtr->Control_BaseAddress, XTOP_KERNEL_CONTROL_ADDR_OUT_R_DATA + 4, (u32)(Data >> 32));
}
...
u64 XTop_kernel_Get_out_r(XTop_kernel *InstancePtr) {
    ...
    Data = XTop_kernel_ReadReg(InstancePtr->Control_BaseAddress, XTOP_KERNEL_CONTROL_ADDR_OUT_R_DATA);
    Data += (u64)XTop_kernel_ReadReg(InstancePtr->Control_BaseAddress, XTOP_KERNEL_CONTROL_ADDR_OUT_R_DATA + 4) << 32;
    return Data;
}
