...
module top_kernel_top_kernel_Pipeline_VITIS_LOOP_107_4 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln107_reg_284;
wire  signed [23:0] val_fu_157_p1;
reg  signed [23:0] val_reg_288;
wire   [63:0] zext_ln110_2_fu_172_p1;
wire    ap_block_pp0_stage0_grp0;
reg   [23:0] empty_fu_72;
wire   [23:0] select_ln111_1_fu_237_p3;
wire    ap_loop_init;
reg    ap_loop_exit_ready_pp0_iter1_reg;
reg   [6:0] j_1_fu_76;
wire   [6:0] add_ln107_fu_140_p2;
reg   [6:0] ap_sig_allocacmp_j;
wire    ap_block_pp0_stage0;
wire    ap_block_pp0_stage0_01001_grp0;
reg    A_buf_we0_local;
reg    A_buf_ce0_local;
wire   [9:0] zext_ln110_1_fu_164_p1;
wire   [9:0] add_ln110_fu_167_p2;
wire  signed [23:0] sext_ln111_fu_177_p0;
wire  signed [23:0] add_ln111_fu_184_p1;
wire  signed [24:0] sext_ln111_1_fu_181_p1;
wire  signed [24:0] sext_ln111_fu_177_p1;
wire   [24:0] add_ln111_1_fu_189_p2;
wire   [23:0] add_ln111_fu_184_p2;
wire   [0:0] tmp_fu_195_p3;
wire   [0:0] tmp_15_fu_203_p3;
wire   [0:0] xor_ln111_fu_211_p2;
wire   [0:0] and_ln111_fu_217_p2;
wire   [0:0] xor_ln111_1_fu_223_p2;
wire   [23:0] select_ln111_fu_229_p3;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln107_fu_134_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln107_fu_134_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_exit_ready_pp0_iter1_reg == 1'b1) & (icmp_ln107_reg_284 == 1'd1))) begin
        p_out_ap_vld = 1'b1;
    end else begin
        p_out_ap_vld = 1'b0;
    end
...
assign A_buf_address0 = zext_ln110_2_fu_172_p1;

assign A_buf_ce0 = A_buf_ce0_local;

assign A_buf_d0 = val_reg_288;

assign A_buf_we0 = A_buf_we0_local;

assign add_ln107_fu_140_p2 = (ap_sig_allocacmp_j + 7'd1);

assign add_ln110_fu_167_p2 = (zext_ln110 + zext_ln110_1_fu_164_p1);

assign add_ln111_1_fu_189_p2 = ($signed(sext_ln111_1_fu_181_p1) + $signed(sext_ln111_fu_177_p1));

assign add_ln111_fu_184_p1 = empty_fu_72;

assign add_ln111_fu_184_p2 = ($signed(val_reg_288) + $signed(add_ln111_fu_184_p1));

assign and_ln111_fu_217_p2 = (xor_ln111_fu_211_p2 & tmp_15_fu_203_p3);
...
assign icmp_ln107_fu_134_p2 = ((ap_sig_allocacmp_j == 7'd64) ? 1'b1 : 1'b0);
...
assign select_ln111_1_fu_237_p3 = ((xor_ln111_1_fu_223_p2[0:0] == 1'b1) ? select_ln111_fu_229_p3 : add_ln111_fu_184_p2);

assign select_ln111_fu_229_p3 = ((and_ln111_fu_217_p2[0:0] == 1'b1) ? 24'd8388607 : 24'd8388608);

assign sext_ln111_1_fu_181_p1 = val_reg_288;

assign sext_ln111_fu_177_p0 = empty_fu_72;

assign sext_ln111_fu_177_p1 = sext_ln111_fu_177_p0;

assign tmp_15_fu_203_p3 = add_ln111_fu_184_p2[32'd23];

assign tmp_fu_195_p3 = add_ln111_1_fu_189_p2[32'd24];

assign val_fu_157_p1 = m_axi_A_0_RDATA[23:0];

assign xor_ln111_1_fu_223_p2 = (tmp_fu_195_p3 ^ tmp_15_fu_203_p3);

assign xor_ln111_fu_211_p2 = (tmp_fu_195_p3 ^ 1'd1);

assign zext_ln110_1_fu_164_p1 = j_reg_279_pp0_iter1_reg;

assign zext_ln110_2_fu_172_p1 = add_ln110_fu_167_p2;

endmodule //top_kernel_top_kernel_Pipeline_VITIS_LOOP_107_4
