...
module top_kernel_top_kernel_Pipeline_VITIS_LOOP_20_1_VITIS_LOOP_21_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [23:0] trunc_ln23_fu_198_p1;
reg   [23:0] trunc_ln23_reg_326;
wire   [63:0] zext_ln23_fu_262_p1;
wire    ap_block_pp0_stage0_grp0;
reg   [6:0] j_fu_78;
wire   [6:0] add_ln21_fu_280_p2;
wire    ap_loop_init;
reg   [8:0] i_fu_82;
wire   [8:0] select_ln20_1_fu_228_p3;
reg   [14:0] indvar_flatten_fu_86;
wire   [14:0] add_ln20_1_fu_181_p2;
reg   [14:0] ap_sig_allocacmp_indvar_flatten_load;
wire    ap_block_pp0_stage0;
reg    A_2_we0_local;
wire   [1:0] trunc_ln21_1_fu_240_p1;
reg    A_2_ce0_local;
...
wire   [8:0] add_ln20_fu_208_p2;
wire   [6:0] select_ln20_fu_220_p3;
wire   [7:0] trunc_ln21_fu_236_p1;
wire   [3:0] lshr_ln_fu_244_p4;
wire   [11:0] tmp_149_fu_254_p3;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln20_fu_175_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten_fu_86 <= add_ln20_1_fu_181_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten_fu_86 <= 15'd0;
        end
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln21_1_fu_240_p1 == 2'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln21_1_fu_240_p1 == 2'd0))) begin
        A_1_we0_local = 1'b1;
    end else begin
        A_1_we0_local = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln21_1_fu_240_p1 == 2'd2))) begin
        A_2_we0_local = 1'b1;
    end else begin
        A_2_we0_local = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln21_1_fu_240_p1 == 2'd3))) begin
        A_3_we0_local = 1'b1;
    end else begin
        A_3_we0_local = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln20_fu_175_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign A_1_21_address0 = zext_ln23_fu_262_p1;

assign A_1_21_ce0 = A_1_21_ce0_local;

assign A_1_21_d0 = trunc_ln23_reg_326;

assign A_1_21_we0 = A_1_21_we0_local;

assign A_1_address0 = zext_ln23_fu_262_p1;

assign A_1_ce0 = A_1_ce0_local;

assign A_1_d0 = trunc_ln23_reg_326;

assign A_1_we0 = A_1_we0_local;

assign A_2_address0 = zext_ln23_fu_262_p1;

assign A_2_ce0 = A_2_ce0_local;

assign A_2_d0 = trunc_ln23_reg_326;

assign A_2_we0 = A_2_we0_local;

assign A_3_address0 = zext_ln23_fu_262_p1;

assign A_3_ce0 = A_3_ce0_local;

assign A_3_d0 = trunc_ln23_reg_326;

assign A_3_we0 = A_3_we0_local;

assign add_ln20_1_fu_181_p2 = (ap_sig_allocacmp_indvar_flatten_load + 15'd1);

assign add_ln20_fu_208_p2 = (i_fu_82 + 9'd1);

assign add_ln21_fu_280_p2 = (select_ln20_fu_220_p3 + 7'd1);
...
assign icmp_ln20_fu_175_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 15'd16384) ? 1'b1 : 1'b0);

assign icmp_ln21_fu_214_p2 = ((j_fu_78 == 7'd64) ? 1'b1 : 1'b0);

assign lshr_ln_fu_244_p4 = {{select_ln20_fu_220_p3[5:2]}};
...
assign select_ln20_1_fu_228_p3 = ((icmp_ln21_fu_214_p2[0:0] == 1'b1) ? add_ln20_fu_208_p2 : i_fu_82);

assign select_ln20_fu_220_p3 = ((icmp_ln21_fu_214_p2[0:0] == 1'b1) ? 7'd0 : j_fu_78);

assign tmp_149_fu_254_p3 = {{trunc_ln21_fu_236_p1}, {lshr_ln_fu_244_p4}};

assign trunc_ln21_1_fu_240_p1 = select_ln20_fu_220_p3[1:0];

assign trunc_ln21_fu_236_p1 = select_ln20_1_fu_228_p3[7:0];

assign trunc_ln23_fu_198_p1 = m_axi_A_0_RDATA[23:0];

assign zext_ln23_fu_262_p1 = tmp_149_fu_254_p3;

endmodule //top_kernel_top_kernel_Pipeline_VITIS_LOOP_20_1_VITIS_LOOP_21_2
