...
entity top_kernel_top_kernel_Pipeline_VITIS_LOOP_132_8 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of top_kernel_top_kernel_Pipeline_VITIS_LOOP_132_8 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln132_fu_134_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln132_reg_284 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln134_fu_157_p1 : STD_LOGIC_VECTOR (23 downto 0);
    signal trunc_ln134_reg_288 : STD_LOGIC_VECTOR (23 downto 0);
    signal zext_ln134_2_fu_172_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0_grp0 : BOOLEAN;
    signal empty_fu_72 : STD_LOGIC_VECTOR (23 downto 0) := "000000000000000000000000";
    signal select_ln135_1_fu_237_p3 : STD_LOGIC_VECTOR (23 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_loop_exit_ready_pp0_iter1_reg : STD_LOGIC;
    signal j_2_fu_76 : STD_LOGIC_VECTOR (6 downto 0) := "0000000";
    signal add_ln132_fu_140_p2 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal zext_ln134_1_fu_164_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal add_ln134_fu_167_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal sext_ln135_fu_177_p0 : STD_LOGIC_VECTOR (23 downto 0);
    signal add_ln135_fu_184_p1 : STD_LOGIC_VECTOR (23 downto 0);
    signal sext_ln135_1_fu_181_p1 : STD_LOGIC_VECTOR (24 downto 0);
    signal sext_ln135_fu_177_p1 : STD_LOGIC_VECTOR (24 downto 0);
    signal add_ln135_1_fu_189_p2 : STD_LOGIC_VECTOR (24 downto 0);
    signal add_ln135_fu_184_p2 : STD_LOGIC_VECTOR (23 downto 0);
    signal tmp_fu_195_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_13_fu_203_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal xor_ln135_fu_211_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln135_fu_217_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal xor_ln135_1_fu_223_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln135_fu_229_p3 : STD_LOGIC_VECTOR (23 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone_grp0_done_reg) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp0))) then
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
                    ...
                    empty_fu_72 <= select_ln135_1_fu_237_p3;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln132_fu_134_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    j_2_fu_76 <= add_ln132_fu_140_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    j_2_fu_76 <= ap_const_lv7_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                icmp_ln132_reg_284 <= icmp_ln132_fu_134_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                trunc_ln134_reg_288 <= trunc_ln134_fu_157_p1;
            end if;
        end if;
    end process;
    ...
    A_buf_address0 <= zext_ln134_2_fu_172_p1(10 - 1 downto 0);
    ...
    add_ln132_fu_140_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j) + unsigned(ap_const_lv7_1));
    add_ln134_fu_167_p2 <= std_logic_vector(unsigned(zext_ln134) + unsigned(zext_ln134_1_fu_164_p1));
    add_ln135_1_fu_189_p2 <= std_logic_vector(signed(sext_ln135_1_fu_181_p1) + signed(sext_ln135_fu_177_p1));
    add_ln135_fu_184_p1 <= empty_fu_72;
    add_ln135_fu_184_p2 <= std_logic_vector(signed(trunc_ln134_reg_288) + signed(add_ln135_fu_184_p1));
    and_ln135_fu_217_p2 <= (xor_ln135_fu_211_p2 and tmp_13_fu_203_p3);
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln132_fu_134_p2)
    begin
        if (((icmp_ln132_fu_134_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_j_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_loop_init, j_2_fu_76, ap_block_pp0_stage0)
    begin
    ...
    icmp_ln132_fu_134_p2 <= "1" when (ap_sig_allocacmp_j = ap_const_lv7_40) else "0";
    ...
    p_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001_grp0, ap_block_pp0_stage0_subdone_grp0_done_reg, icmp_ln132_reg_284, ap_loop_exit_ready_pp0_iter1_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone_grp0_done_reg) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_exit_ready_pp0_iter1_reg = ap_const_logic_1) and (icmp_ln132_reg_284 = ap_const_lv1_1))) then 
    ...
    select_ln135_1_fu_237_p3 <= 
        select_ln135_fu_229_p3 when (xor_ln135_1_fu_223_p2(0) = '1') else 
        add_ln135_fu_184_p2;
    select_ln135_fu_229_p3 <= 
        ap_const_lv24_7FFFFF when (and_ln135_fu_217_p2(0) = '1') else 
        ap_const_lv24_800000;
        sext_ln135_1_fu_181_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln134_reg_288),25));

    sext_ln135_fu_177_p0 <= empty_fu_72;
        sext_ln135_fu_177_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(sext_ln135_fu_177_p0),25));

    tmp_13_fu_203_p3 <= add_ln135_fu_184_p2(23 downto 23);
    tmp_fu_195_p3 <= add_ln135_1_fu_189_p2(24 downto 24);
    trunc_ln134_fu_157_p1 <= m_axi_A_0_RDATA(24 - 1 downto 0);
    xor_ln135_1_fu_223_p2 <= (tmp_fu_195_p3 xor tmp_13_fu_203_p3);
    xor_ln135_fu_211_p2 <= (tmp_fu_195_p3 xor ap_const_lv1_1);
    zext_ln134_1_fu_164_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(j_reg_279_pp0_iter1_reg),10));
    zext_ln134_2_fu_172_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln134_fu_167_p2),64));
end behav;
