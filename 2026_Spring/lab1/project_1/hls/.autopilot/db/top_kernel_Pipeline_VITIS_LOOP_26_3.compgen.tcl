...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename tmp \
    op interface \
    ports { tmp_address0 { O 14 vector } tmp_ce0 { O 1 bit } tmp_we0 { O 1 bit } tmp_d0 { O 24 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_conv_i362 \
    op interface \
    ports { conv_i362 { I 24 vector } } \
} "
}
