...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename A_1_20 \
    op interface \
    ports { A_1_20_address0 { O 11 vector } A_1_20_ce0 { O 1 bit } A_1_20_q0 { I 24 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'A_1_20'"
}
}
