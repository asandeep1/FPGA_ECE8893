set moduleName stage_morphology_Pipeline_DILATION_LOOP_VITIS_LOOP_347_2
set isTopModule 0
...
set cdfgNum 20
set C_modelName {stage_morphology_Pipeline_DILATION_LOOP_VITIS_LOOP_347_2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict eroded_buf { MEM_WIDTH 16 MEM_SIZE 968 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict eroded_buf_1 { MEM_WIDTH 16 MEM_SIZE 968 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict eroded_buf_2 { MEM_WIDTH 16 MEM_SIZE 968 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict eroded_buf_3 { MEM_WIDTH 16 MEM_SIZE 968 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict eroded_buf_4 { MEM_WIDTH 16 MEM_SIZE 968 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict eroded_buf_5 { MEM_WIDTH 16 MEM_SIZE 968 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict eroded_buf_6 { MEM_WIDTH 16 MEM_SIZE 968 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict eroded_buf_7 { MEM_WIDTH 16 MEM_SIZE 968 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict eroded_buf_8 { MEM_WIDTH 16 MEM_SIZE 968 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ eroded_buf int 16 regular {array 484 { 1 3 } 1 1 }  }
	{ eroded_buf_1 int 16 regular {array 484 { 1 3 } 1 1 }  }
	{ eroded_buf_2 int 16 regular {array 484 { 1 3 } 1 1 }  }
	{ eroded_buf_3 int 16 regular {array 484 { 1 3 } 1 1 }  }
	{ eroded_buf_4 int 16 regular {array 484 { 1 3 } 1 1 }  }
	{ eroded_buf_5 int 16 regular {array 484 { 1 3 } 1 1 }  }
	{ eroded_buf_6 int 16 regular {array 484 { 1 3 } 1 1 }  }
	{ eroded_buf_7 int 16 regular {array 484 { 1 3 } 1 1 }  }
	{ eroded_buf_8 int 16 regular {array 484 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "eroded_buf", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "eroded_buf_1", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "eroded_buf_2", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "eroded_buf_3", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "eroded_buf_4", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "eroded_buf_5", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "eroded_buf_6", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "eroded_buf_7", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "eroded_buf_8", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ morphology_stream_din sc_out sc_lv 16 signal 9 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "eroded_buf_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "eroded_buf", "role": "q0" }} , 
 	...
 	{ "name": "eroded_buf_1_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "eroded_buf_1", "role": "q0" }} , 
 	...
 	{ "name": "eroded_buf_2_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "eroded_buf_2", "role": "q0" }} , 
 	...
 	{ "name": "eroded_buf_3_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "eroded_buf_3", "role": "q0" }} , 
 	...
 	{ "name": "eroded_buf_4_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "eroded_buf_4", "role": "q0" }} , 
 	...
 	{ "name": "eroded_buf_5_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "eroded_buf_5", "role": "q0" }} , 
 	...
 	{ "name": "eroded_buf_6_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "eroded_buf_6", "role": "q0" }} , 
 	...
 	{ "name": "eroded_buf_7_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "eroded_buf_7", "role": "q0" }} , 
 	...
 	{ "name": "eroded_buf_8_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "eroded_buf_8", "role": "q0" }} , 
...
set ArgLastReadFirstWriteLatency {
	stage_morphology_Pipeline_DILATION_LOOP_VITIS_LOOP_347_2 {
...
set Spec2ImplPortList { 
	eroded_buf { ap_memory {  { eroded_buf_address0 mem_address 1 9 }  { eroded_buf_ce0 mem_ce 1 1 }  { eroded_buf_q0 mem_dout 0 16 } } }
	eroded_buf_1 { ap_memory {  { eroded_buf_1_address0 mem_address 1 9 }  { eroded_buf_1_ce0 mem_ce 1 1 }  { eroded_buf_1_q0 mem_dout 0 16 } } }
	eroded_buf_2 { ap_memory {  { eroded_buf_2_address0 mem_address 1 9 }  { eroded_buf_2_ce0 mem_ce 1 1 }  { eroded_buf_2_q0 mem_dout 0 16 } } }
	eroded_buf_3 { ap_memory {  { eroded_buf_3_address0 mem_address 1 9 }  { eroded_buf_3_ce0 mem_ce 1 1 }  { eroded_buf_3_q0 mem_dout 0 16 } } }
	eroded_buf_4 { ap_memory {  { eroded_buf_4_address0 mem_address 1 9 }  { eroded_buf_4_ce0 mem_ce 1 1 }  { eroded_buf_4_q0 mem_dout 0 16 } } }
	eroded_buf_5 { ap_memory {  { eroded_buf_5_address0 mem_address 1 9 }  { eroded_buf_5_ce0 mem_ce 1 1 }  { eroded_buf_5_q0 mem_dout 0 16 } } }
	eroded_buf_6 { ap_memory {  { eroded_buf_6_address0 mem_address 1 9 }  { eroded_buf_6_ce0 mem_ce 1 1 }  { eroded_buf_6_q0 mem_dout 0 16 } } }
	eroded_buf_7 { ap_memory {  { eroded_buf_7_address0 mem_address 1 9 }  { eroded_buf_7_ce0 mem_ce 1 1 }  { eroded_buf_7_q0 mem_dout 0 16 } } }
	eroded_buf_8 { ap_memory {  { eroded_buf_8_address0 mem_address 1 9 }  { eroded_buf_8_ce0 mem_ce 1 1 }  { eroded_buf_8_q0 mem_dout 0 16 } } }
