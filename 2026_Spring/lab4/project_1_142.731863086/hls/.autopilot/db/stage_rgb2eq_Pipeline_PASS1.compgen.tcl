...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler top_kernel_sparsemux_7_2_1_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {onehotencoding_realdef}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { intensity_buf_address0 { O 12 vector } intensity_buf_ce0 { O 1 bit } intensity_buf_we0 { O 1 bit } intensity_buf_d0 { O 16 vector } } \
} "
} else {
