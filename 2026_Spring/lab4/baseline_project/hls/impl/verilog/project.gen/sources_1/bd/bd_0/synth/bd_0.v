...
module bd_0
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.IN_R_ADDRESS0 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.IN_R_ADDRESS0, LAYERED_METADATA undef" *) output [13:0]in_r_address0;
  output in_r_ce0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.IN_R_Q0 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.IN_R_Q0, LAYERED_METADATA undef" *) input [15:0]in_r_q0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.OUT_R_ADDRESS0 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.OUT_R_ADDRESS0, LAYERED_METADATA undef" *) output [13:0]out_r_address0;
  output out_r_ce0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.OUT_R_D0 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.OUT_R_D0, LAYERED_METADATA undef" *) output [15:0]out_r_d0;
  output out_r_we0;
