...
(* CHECK_LICENSE_TYPE = "bd_0_hls_inst_0,top_kernel,{}" *) (* CORE_GENERATION_INFO = "bd_0_hls_inst_0,top_kernel,{x_ipProduct=Vivado 2025.1.1,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=top_kernel,x_ipVersion=1.0,x_ipCoreRevision=2114541340,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "HLS" *) (* X_CORE_INFO = "top_kernel,Vivado 2025.1.1" *) (* hls_module = "yes" *) 
module bd_0_hls_inst_0(in_r_ce0, out_r_ce0, out_r_we0, ap_clk, ap_rst, 
  ap_done, ap_idle, ap_ready, ap_start, in_r_address0, in_r_q0, out_r_address0, out_r_d0)
/* synthesis syn_black_box black_box_pad_pin="in_r_ce0,out_r_ce0,out_r_we0,ap_rst,ap_done,ap_idle,ap_ready,ap_start,in_r_address0[13:0],in_r_q0[15:0],out_r_address0[13:0],out_r_d0[15:0]" */
