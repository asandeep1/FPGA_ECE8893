...
extern "C"
void apatb_top_kernel_hw(void* __xlx_apatb_param_in_r, void* __xlx_apatb_param_out_r)
{
  ...
  try {
    ...
    top_kernel_hw_stub_wrapper(__xlx_apatb_param_in_r, __xlx_apatb_param_out_r);
