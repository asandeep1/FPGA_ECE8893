...
dict set ap_memory_interface_dict out_r { MEM_WIDTH 16 MEM_SIZE 32768 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
...
set ArgLastReadFirstWriteLatency {
	top_kernel {
		...
		stage1_out {Type IO LastRead -1 FirstWrite -1}
		stage2_out {Type IO LastRead -1 FirstWrite -1}
		stage3_out {Type IO LastRead -1 FirstWrite -1}
		stage4_out {Type IO LastRead -1 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "197894", "Max" : "2622726"}
	, {"Name" : "Interval", "Min" : "197895", "Max" : "2622727"}
]}
