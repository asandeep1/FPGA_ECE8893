...
define void @apatb_top_kernel_ir(%"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="16384" %in, %"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull "fpga.decayed.dim.hint"="16384" %out) local_unnamed_addr #0 {
entry:
...
entry:
  call fastcc void @"onebyonecpy_hls.p0a16384struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>.20"([16384 x i16]* %1, [16384 x %"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"]* %0)
  call fastcc void @"onebyonecpy_hls.p0a16384struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>.20"([16384 x i16]* %3, [16384 x %"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"]* %2)
  ret void
}
...
copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a16384struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>.16"([16384 x %"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"]* nonnull %dst, [16384 x i16]* %src, i64 16384)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a16384struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>.16"([16384 x %"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"]* "unpacked"="0" %dst, [16384 x i16]* nocapture readonly "unpacked"="1.0" %src, i64 "unpacked"="2" %num) local_unnamed_addr #4 {
entry:
  %0 = icmp eq [16384 x %"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0a16384struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>.20"([16384 x i16]* nocapture "unpacked"="0.0" %dst, [16384 x %"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"]* readonly "unpacked"="1" %src) unnamed_addr #3 {
entry:
  %0 = icmp eq [16384 x %"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"]* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a16384struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>.23"([16384 x i16]* %dst, [16384 x %"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"]* nonnull %src, i64 16384)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a16384struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>.23"([16384 x i16]* nocapture "unpacked"="0.0" %dst, [16384 x %"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"]* readonly "unpacked"="1" %src, i64 "unpacked"="2" %num) local_unnamed_addr #4 {
entry:
  %0 = icmp eq [16384 x %"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"]* %src, null
  br i1 %0, label %ret, label %copy
