...
`define TV_OUT_out_r ""
    ...
    mem_model_pages_with_diffofst#(16,8) mem_blk_pages_gmem1;
    int blk_id_gmem1 = 0;
...
misc_if.dut2tb_ap_done = 0;
        ...
        mem_blk_pages_gmem0.whole_page_size=32800;
        mem_blk_pages_gmem0.maxi_bundlevar_fpath["in_r"]=`TV_IN_OFFSET_in_r;
        mem_blk_pages_gmem0.set_binary(1);
        mem_blk_pages_gmem0.tvinload_pagechk_atinit(fpath, 16384*((16+7)/8), 0, 0, "");
        fpath.delete();

        fpath.push_back(`TV_IN_gmem1);
        mem_blk_pages_gmem1 = mem_model_pages_with_diffofst#(16,8)::type_id::create("mem_blk_pages_gmem1");
        mem_blk_pages_gmem1.whole_page_size=32800;
        mem_blk_pages_gmem1.maxi_bundlevar_fpath["out_r"]=`TV_IN_OFFSET_out_r;
        mem_blk_pages_gmem1.set_binary(1);
        mem_blk_pages_gmem1.tvinload_pagechk_atinit(fpath, 16384*((16+7)/8), 0, 0, "");
