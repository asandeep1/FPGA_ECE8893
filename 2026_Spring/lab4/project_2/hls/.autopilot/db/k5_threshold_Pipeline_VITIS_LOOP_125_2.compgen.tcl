...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename local_storage \
    op interface \
    ports { local_storage_address0 { O 14 vector } local_storage_ce0 { O 1 bit } local_storage_q0 { I 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'local_storage'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_global_avg \
    op interface \
    ports { global_avg { I 15 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln125 \
    op interface \
    ports { sext_ln125 { I 63 vector } } \
} "
}
