set moduleName k5_threshold_Pipeline_VITIS_LOOP_125_2
set isTopModule 0
...
set cdfgNum 12
set C_modelName {k5_threshold_Pipeline_VITIS_LOOP_125_2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict local_storage { MEM_WIDTH 16 MEM_SIZE 32768 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ global_avg int 15 regular  }
	{ gmem1 int 16 regular {axi_master 1}  }
	{ sext_ln125 int 63 regular  }
	{ local_storage int 16 regular {array 16384 { 1 3 } 1 1 } {global 0}  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "global_avg", "interface" : "wire", "bitwidth" : 15, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sext_ln125", "interface" : "wire", "bitwidth" : 63, "direction" : "READONLY"} , 
 	{ "Name" : "local_storage", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ global_avg sc_in sc_lv 15 signal 0 } 
	{ sext_ln125 sc_in sc_lv 63 signal 2 } 
	{ local_storage_address0 sc_out sc_lv 14 signal 3 } 
	{ local_storage_ce0 sc_out sc_logic 1 signal 3 } 
	{ local_storage_q0 sc_in sc_lv 16 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "global_avg", "direction": "in", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "global_avg", "role": "default" }} , 
 	{ "name": "sext_ln125", "direction": "in", "datatype": "sc_lv", "bitwidth":63, "type": "signal", "bundle":{"name": "sext_ln125", "role": "default" }} , 
 	...
 	{ "name": "local_storage_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "local_storage", "role": "q0" }}  ]}

set ArgLastReadFirstWriteLatency {
	k5_threshold_Pipeline_VITIS_LOOP_125_2 {
		global_avg {Type I LastRead 0 FirstWrite -1}
		gmem1 {Type O LastRead -1 FirstWrite 2}
		sext_ln125 {Type I LastRead 0 FirstWrite -1}
		local_storage {Type I LastRead 0 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	global_avg { ap_none {  { global_avg in_data 0 15 } } }
	...
	sext_ln125 { ap_none {  { sext_ln125 in_data 0 63 } } }
	local_storage { ap_memory {  { local_storage_address0 mem_address 1 14 }  { local_storage_ce0 mem_ce 1 1 }  { local_storage_q0 mem_dout 0 16 } } }
}
