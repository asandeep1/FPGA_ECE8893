...
set ArgLastReadFirstWriteLatency {
	top_kernel {
		...
		s1 {Type IO LastRead -1 FirstWrite -1}
		...
		s2 {Type IO LastRead -1 FirstWrite -1}
		...
		s3_dil {Type IO LastRead -1 FirstWrite -1}
		s3_ero {Type IO LastRead -1 FirstWrite -1}
		s4 {Type IO LastRead -1 FirstWrite -1}
		local_storage {Type IO LastRead -1 FirstWrite -1}}
	entry_proc {
		out_r {Type I LastRead 0 FirstWrite -1}
		out_r_c {Type O LastRead -1 FirstWrite 0}}
	Loop_VITIS_LOOP_145_1_proc {
		in_r {Type I LastRead 0 FirstWrite -1}
		gmem0 {Type I LastRead 9 FirstWrite -1}
		in_stream {Type O LastRead -1 FirstWrite 10}}
	k1_contrast {
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "49176", "Max" : "49176"}
	, {"Name" : "Interval", "Min" : "49161", "Max" : "49161"}
]}
