...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler top_kernel_k5_threshold_local_storage_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_s4 \
    op interface \
    ports { s4_dout { I 16 vector } s4_empty_n { I 1 bit } s4_read { O 1 bit } s4_num_data_valid { I 9 vector } s4_fifo_cap { I 9 vector } } \
} "
}
