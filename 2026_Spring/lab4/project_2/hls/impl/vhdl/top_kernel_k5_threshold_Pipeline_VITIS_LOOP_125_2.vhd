...
entity top_kernel_k5_threshold_Pipeline_VITIS_LOOP_125_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of top_kernel_k5_threshold_Pipeline_VITIS_LOOP_125_2 is 
...
attribute shreg_extract : string;
    ...
    signal sext_ln123_fu_97_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal sext_ln123_reg_162 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal select_ln127_fu_136_p3 : STD_LOGIC_VECTOR (15 downto 0);
    signal select_ln127_reg_176 : STD_LOGIC_VECTOR (15 downto 0);
    signal zext_ln125_fu_121_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal ap_block_pp0_stage0_01001_grp1 : BOOLEAN;
    signal i_fu_56 : STD_LOGIC_VECTOR (14 downto 0) := "000000000000000";
    signal add_ln125_fu_115_p2 : STD_LOGIC_VECTOR (14 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i_1 : STD_LOGIC_VECTOR (14 downto 0);
    signal local_storage_ce0_local : STD_LOGIC;
    signal icmp_ln127_fu_131_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln125_fu_109_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    i_fu_56 <= add_ln125_fu_115_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    i_fu_56 <= ap_const_lv15_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    select_ln127_reg_176(7 downto 0) <= "00000000";
    select_ln127_reg_176(15 downto 9) <= "0000000";
    ...
    add_ln125_fu_115_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1) + unsigned(ap_const_lv15_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln125_fu_109_p2)
    begin
        if (((icmp_ln125_fu_109_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln125_fu_109_p2 <= "1" when (ap_sig_allocacmp_i_1 = ap_const_lv15_4000) else "0";
    icmp_ln127_fu_131_p2 <= "1" when (signed(local_storage_q0) > signed(sext_ln123_reg_162)) else "0";
    local_storage_address0 <= zext_ln125_fu_121_p1(14 - 1 downto 0);
    local_storage_ce0 <= local_storage_ce0_local;

    local_storage_ce0_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_11001)
    begin
    ...
    m_axi_gmem1_0_WDATA <= select_ln127_reg_176;
    ...
    select_ln127_fu_136_p3 <= 
        ap_const_lv16_100 when (icmp_ln127_fu_131_p2(0) = '1') else 
        ap_const_lv16_0;
        sext_ln123_fu_97_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(global_avg),16));

    zext_ln125_fu_121_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_1),64));
end behav;
