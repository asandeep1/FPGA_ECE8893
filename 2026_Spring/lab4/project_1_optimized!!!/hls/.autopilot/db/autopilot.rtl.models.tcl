set SynModuleInfo {
  ...
  {SRCNAME stage_rgb2eq_Pipeline_VITIS_LOOP_99_2 MODELNAME stage_rgb2eq_Pipeline_VITIS_LOOP_99_2 RTLNAME top_kernel_stage_rgb2eq_Pipeline_VITIS_LOOP_99_2
    SUBMODULES {
  ...
  {SRCNAME stage_gaussian_Pipeline_GAUSSIAN_OUT_VITIS_LOOP_144_1 MODELNAME stage_gaussian_Pipeline_GAUSSIAN_OUT_VITIS_LOOP_144_1 RTLNAME top_kernel_stage_gaussian_Pipeline_GAUSSIAN_OUT_VITIS_LOOP_144_1
    SUBMODULES {
  ...
  {SRCNAME stage_bilateral_Pipeline_VITIS_LOOP_181_1 MODELNAME stage_bilateral_Pipeline_VITIS_LOOP_181_1 RTLNAME top_kernel_stage_bilateral_Pipeline_VITIS_LOOP_181_1
    SUBMODULES {
  ...
  {SRCNAME stage_bilateral_Pipeline_BILATERAL_OUT_VITIS_LOOP_200_4 MODELNAME stage_bilateral_Pipeline_BILATERAL_OUT_VITIS_LOOP_200_4 RTLNAME top_kernel_stage_bilateral_Pipeline_BILATERAL_OUT_VITIS_LOOP_200_4
    SUBMODULES {
      ...
      {MODELNAME top_kernel_fexp_32ns_32ns_32_22_full_dsp_1 RTLNAME top_kernel_fexp_32ns_32ns_32_22_full_dsp_1 BINDTYPE op TYPE fexp IMPL fulldsp LATENCY 21 ALLOW_PRAGMA 1}
  ...
  {SRCNAME stage_morphology_Pipeline_EROSION_LOOP_VITIS_LOOP_265_1 MODELNAME stage_morphology_Pipeline_EROSION_LOOP_VITIS_LOOP_265_1 RTLNAME top_kernel_stage_morphology_Pipeline_EROSION_LOOP_VITIS_LOOP_265_1}
  {SRCNAME stage_morphology_Pipeline_DILATION_LOOP_VITIS_LOOP_293_4 MODELNAME stage_morphology_Pipeline_DILATION_LOOP_VITIS_LOOP_293_4 RTLNAME top_kernel_stage_morphology_Pipeline_DILATION_LOOP_VITIS_LOOP_293_4}
  {SRCNAME stage_morphology MODELNAME stage_morphology RTLNAME top_kernel_stage_morphology}
  {SRCNAME Loop_VITIS_LOOP_354_1_proc MODELNAME Loop_VITIS_LOOP_354_1_proc RTLNAME top_kernel_Loop_VITIS_LOOP_354_1_proc
    SUBMODULES {
  ...
  {SRCNAME top_kernel MODELNAME top_kernel RTLNAME top_kernel IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME top_kernel_fifo_w16_d128_A RTLNAME top_kernel_fifo_w16_d128_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME equalized_stream_U}
      {MODELNAME top_kernel_fifo_w16_d128_A RTLNAME top_kernel_fifo_w16_d128_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME gaussian_stream_U}
      {MODELNAME top_kernel_fifo_w16_d128_A RTLNAME top_kernel_fifo_w16_d128_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME bilateral_stream_U}
      {MODELNAME top_kernel_fifo_w16_d128_A RTLNAME top_kernel_fifo_w16_d128_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME morphology_stream_U}
      {MODELNAME top_kernel_start_for_Loop_VITIS_LOOP_354_1_proc_U0 RTLNAME top_kernel_start_for_Loop_VITIS_LOOP_354_1_proc_U0 BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME start_for_Loop_VITIS_LOOP_354_1_proc_U0_U}
