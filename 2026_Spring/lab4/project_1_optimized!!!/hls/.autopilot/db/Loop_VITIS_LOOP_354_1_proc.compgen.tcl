...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { morphology_stream_dout { I 16 vector } morphology_stream_empty_n { I 1 bit } morphology_stream_read { O 1 bit } morphology_stream_num_data_valid { I 8 vector } morphology_stream_fifo_cap { I 8 vector } } \
} "
}
