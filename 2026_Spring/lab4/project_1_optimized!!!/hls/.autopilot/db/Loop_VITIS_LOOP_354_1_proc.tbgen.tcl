set moduleName Loop_VITIS_LOOP_354_1_proc
set isTopModule 0
...
set cdfgNum 20
set C_modelName {Loop_VITIS_LOOP_354_1_proc}
...
set portList { 
	...
	{ morphology_stream_num_data_valid sc_in sc_lv 8 signal 2 } 
	{ morphology_stream_fifo_cap sc_in sc_lv 8 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "morphology_stream_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "morphology_stream", "role": "num_data_valid" }} , 
 	{ "name": "morphology_stream_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "morphology_stream", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	...
	morphology_stream { ap_fifo {  { morphology_stream_dout fifo_data_in 0 16 }  { morphology_stream_empty_n fifo_status 0 1 }  { morphology_stream_read fifo_port_we 1 1 }  { morphology_stream_num_data_valid fifo_status_num_data_valid 0 8 }  { morphology_stream_fifo_cap fifo_update 0 8 } } }
}
