...
set C_modelArgList {
	...
	{ in_b int 64 regular  }
	{ equalized_stream int 16 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in_r","offset": { "type": "dynamic","port_name": "in_r","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "equalized_stream", "interface" : "fifo", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ equalized_stream_din sc_out sc_lv 16 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "equalized_stream_din", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "equalized_stream", "role": "din" }} , 
...
set ArgLastReadFirstWriteLatency {
	stage_rgb2eq {
		...
		equalized_stream {Type O LastRead -1 FirstWrite 69}}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "12748", "Max" : "12748"}
	, {"Name" : "Interval", "Min" : "12748", "Max" : "12748"}
]}
...
set Spec2ImplPortList { 
	...
	equalized_stream { ap_fifo {  { equalized_stream_din fifo_data_in 1 16 }  { equalized_stream_full_n fifo_status 0 1 }  { equalized_stream_write fifo_port_we 1 1 }  { equalized_stream_num_data_valid fifo_status_num_data_valid 0 32 }  { equalized_stream_fifo_cap fifo_update 0 32 } } }
}
