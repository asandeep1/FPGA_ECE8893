...
set portList { 
	...
	{ gaussian_stream_dout sc_in sc_lv 16 signal 0 } 
	{ gaussian_stream_empty_n sc_in sc_logic 1 signal 0 } 
	{ gaussian_stream_read sc_out sc_logic 1 signal 0 } 
	{ gaussian_stream_num_data_valid sc_in sc_lv 8 signal 0 } 
	{ gaussian_stream_fifo_cap sc_in sc_lv 8 signal 0 } 
	{ bilateral_stream_din sc_out sc_lv 16 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "gaussian_stream_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "gaussian_stream", "role": "num_data_valid" }} , 
 	{ "name": "gaussian_stream_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "gaussian_stream", "role": "fifo_cap" }} , 
...
set ArgLastReadFirstWriteLatency {
	...
	stage_bilateral_Pipeline_VITIS_LOOP_181_1 {
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "8362", "Max" : "8362"}
	, {"Name" : "Interval", "Min" : "8362", "Max" : "8362"}
]}
...
set Spec2ImplPortList { 
	gaussian_stream { ap_fifo {  { gaussian_stream_dout fifo_data_in 0 16 }  { gaussian_stream_empty_n fifo_status 0 1 }  { gaussian_stream_read fifo_port_we 1 1 }  { gaussian_stream_num_data_valid fifo_status_num_data_valid 0 8 }  { gaussian_stream_fifo_cap fifo_update 0 8 } } }
