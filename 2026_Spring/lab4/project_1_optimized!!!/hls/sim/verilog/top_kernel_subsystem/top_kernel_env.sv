...
`ifndef TOP_KERNEL_ENV__SV                                                                                   
    ...
    class top_kernel_env extends uvm_env;                                                                          
        ...
        axi_pkg::axi_env#(64,4,8,3,1) axi_master_gmem3;
    ...
    function void top_kernel_env::build_phase(uvm_phase phase);                                                    
        ...
        top_kernel_cfg.gmem3_cfg.set_default();
        top_kernel_cfg.gmem3_cfg.drv_type = axi_pkg::SLAVE;
        top_kernel_cfg.gmem3_cfg.reset_level = axi_pkg::RESET_LEVEL_LOW;
        top_kernel_cfg.gmem3_cfg.write_latency_mode = TRANSACTION_FIRST;
        top_kernel_cfg.gmem3_cfg.read_latency_mode = TRANSACTION_FIRST;
        uvm_config_db#(axi_pkg::axi_cfg)::set(this, "axi_master_gmem3*", "cfg", top_kernel_cfg.gmem3_cfg);
        axi_master_gmem3 = axi_pkg::axi_env#(64,4,8,3,1)::type_id::create("axi_master_gmem3", this);
    ...
    function void top_kernel_env::connect_phase(uvm_phase phase);
        ...
        if(top_kernel_cfg.gmem3_cfg.drv_type==axi_pkg::MASTER ||top_kernel_cfg.gmem3_cfg.drv_type==axi_pkg::SLAVE)
            top_kernel_virtual_sqr.gmem3_sqr = axi_master_gmem3.vsqr;
