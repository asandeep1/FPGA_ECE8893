...
// tvout file define:
#define AUTOTB_TVOUT_PC_out_r "../tv/rtldatafile/rtl.top_kernel.autotvout_out_r.dat"
...
void apatb_top_kernel_hw(void* __xlx_apatb_param_in_r, void* __xlx_apatb_param_in_g, void* __xlx_apatb_param_in_b, void* __xlx_apatb_param_out_r)
{
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port1 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_in_g),
#else
  ...
  port1.param = { __xlx_apatb_param_in_g };
  port1.mname = { "in_g" };
  port1.nbytes = { 16384 };
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port2 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_in_b),
#else
  ...
  port2.param = { __xlx_apatb_param_in_b };
  port2.mname = { "in_b" };
  port2.nbytes = { 16384 };
