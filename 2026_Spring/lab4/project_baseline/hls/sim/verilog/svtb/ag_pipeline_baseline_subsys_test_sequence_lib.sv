...
//
//==============================================================
`ifndef AG_PIPELINE_BASELINE_SUBSYS_TEST_SEQUENCE_LIB__SV                                              
    `define AG_PIPELINE_BASELINE_SUBSYS_TEST_SEQUENCE_LIB__SV                                          
                                                                                                    
                                                                                                    
    `include "uvm_macros.svh"                                                                     
                                                                                                    
    class ag_pipeline_baseline_subsys_test_sequence_lib extends uvm_sequence;                                
                                                                                                    
        function new (string name = "ag_pipeline_baseline_subsys_test_sequence_lib");                      
            super.new(name);                                                                        
            `uvm_info(this.get_full_name(), "new is called", UVM_LOW)                             
        endfunction                                                                                 
                                                                                                    
        `uvm_object_utils(ag_pipeline_baseline_subsys_test_sequence_lib)                                     
        `uvm_declare_p_sequencer(ag_pipeline_baseline_virtual_sequencer)                                     
        ...
        virtual task body();                                                                        
            ...
            if (!uvm_config_db#(ag_pipeline_baseline_reference_model)::get(p_sequencer,"", "refm", refm))
