...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.ag_pipeline_baseline.autotvin_red_in.dat"
         "c.ag_pipeline_baseline.autotvin_nir_in.dat"
         "c.ag_pipeline_baseline.autotvin_profile_out.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.ag_pipeline_baseline.autotvout_profile_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
