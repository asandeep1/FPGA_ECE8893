...
if {[file isfile ag_pipeline_baseline.autotvin.dat]} {
	file delete -force ag_pipeline_baseline.autotvin.dat
}

if {[file isfile ag_pipeline_baseline.autotvout.dat]} {
	file delete -force ag_pipeline_baseline.autotvout.dat
}
