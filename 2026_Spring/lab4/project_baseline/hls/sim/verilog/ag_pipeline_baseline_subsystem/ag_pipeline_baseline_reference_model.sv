...
`ifndef AG_PIPELINE_BASELINE_REFERENCE_MODEL_SV
`define AG_PIPELINE_BASELINE_REFERENCE_MODEL_SV

class ag_pipeline_baseline_reference_model extends uvm_component;
    ...
    `uvm_component_utils_begin(ag_pipeline_baseline_reference_model)
