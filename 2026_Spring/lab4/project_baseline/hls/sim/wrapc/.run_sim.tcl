...
# 
# ==============================================================
set ::env(LD_LIBRARY_PATH) /tools/software/xilinx/2025.1.1/Vitis/lnx64/tools/fpo_v7_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /tools/software/xilinx/2025.1.1/Vitis/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /tools/software/xilinx/2025.1.1/Vitis/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /tools/software/xilinx/2025.1.1/Vitis/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /tools/software/xilinx/2025.1.1/Vitis/tps/lnx64/gcc-8.3.0/lib:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /tools/software/xilinx/2025.1.1/Vitis/lib/lnx64.o/Rhel:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "ag_pipeline_baseline.autotvin.dat"
	set constFileTvOut       "ag_pipeline_baseline.autotvout.dat"
	set constFileHdlTvIn     "ag_pipeline_baseline.autohdltvin.dat"
	set constFileHdlTvOut    "ag_pipeline_baseline.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
