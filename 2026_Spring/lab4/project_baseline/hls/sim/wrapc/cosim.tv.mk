...
AUTOPILOT_ROOT := /tools/software/xilinx/2025.1.1/Vitis
...
IFLAG += -fPIC
ifndef AP_GCC_PATH
  AP_GCC_PATH := /tools/software/xilinx/2025.1.1/Vitis/tps/lnx64/gcc-8.3.0/bin
endif
AUTOPILOT_TOOL = ${AUTOPILOT_ROOT}/${AUTOPILOT_MACH}/tools
AUTOPILOT_TECH = ${AUTOPILOT_ROOT}/common/technology
  AP_CLANG_PATH := /tools/software/xilinx/2025.1.1/Vitis/lnx64/tools/vcxx/libexec/
TOOLCHAIN += --gcc-toolchain=/tools/software/xilinx/2025.1.1/Vitis/tps/lnx64/gcc-8.3.0
LFLAG += --gcc-toolchain=/tools/software/xilinx/2025.1.1/Vitis/tps/lnx64/gcc-8.3.0
...
$(ObjDir)/host.cpp_pre.cpp.tb.o : host.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling host.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
...
$(ObjDir)/baseline.cpp_pre.cpp.tb.o : baseline.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling baseline.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
