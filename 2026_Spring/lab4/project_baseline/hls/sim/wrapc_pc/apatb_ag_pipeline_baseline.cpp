...
#define AUTOTB_TVOUT_red_in "../tv/cdatafile/c.ag_pipeline_baseline.autotvout_red_in.dat"
#define AUTOTB_TVIN_nir_in "../tv/cdatafile/c.ag_pipeline_baseline.autotvin_nir_in.dat"
#define AUTOTB_TVOUT_nir_in "../tv/cdatafile/c.ag_pipeline_baseline.autotvout_nir_in.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_profile_out "../tv/rtldatafile/rtl.ag_pipeline_baseline.autotvout_profile_out.dat"
...
extern "C"
void ag_pipeline_baseline_hw_stub_wrapper(void*, void*, void*);

extern "C"
void apatb_ag_pipeline_baseline_hw(void* __xlx_apatb_param_red_in, void* __xlx_apatb_param_nir_in, void* __xlx_apatb_param_profile_out)
{
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port0 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_red_in),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_red_in),
#endif
#endif
    .hasWrite = { false },
    .max_nbytes = { 0 },
  };
  port0.param = { __xlx_apatb_param_red_in };
  port0.mname = { "red_in" };
  port0.nbytes = { 32768 };
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port1 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_nir_in),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_nir_in),
#endif
#endif
    .hasWrite = { false },
    .max_nbytes = { 0 },
  };
  port1.param = { __xlx_apatb_param_nir_in };
  port1.mname = { "nir_in" };
  port1.nbytes = { 32768 };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_profile_out),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_profile_out),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_profile_out),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_profile_out),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_profile_out),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_profile_out),
#endif
#endif
    .hasWrite = { true },
    .max_nbytes = { 0 },
  };
  port2.param = { __xlx_apatb_param_profile_out };
  port2.mname = { "profile_out" };
  port2.nbytes = { 256 };
  ...
  try {
    ...
    ag_pipeline_baseline_hw_stub_wrapper(__xlx_apatb_param_red_in, __xlx_apatb_param_nir_in, __xlx_apatb_param_profile_out);
