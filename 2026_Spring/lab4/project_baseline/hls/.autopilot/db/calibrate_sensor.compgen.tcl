...
set name ag_pipeline_baseline_mul_16s_9ns_25_1_1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename output_r \
    op interface \
    ports { output_r_address0 { O 14 vector } output_r_ce0 { O 1 bit } output_r_we0 { O 1 bit } output_r_d0 { O 15 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_gain_val \
    op interface \
    ports { gain_val { I 9 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_offset_val \
    op interface \
    ports { offset_val { I 4 vector } } \
} "
}
