set moduleName extract_edges_and_profile
set isTopModule 0
...
set cdfgNum 6
set C_modelName {extract_edges_and_profile}
...
set C_modelArgList {
	{ in_r int 16 regular {array 16384 { 1 1 } 1 1 }  }
...
set portList { 
	...
	{ profile_out_address0 sc_out sc_lv 7 signal 1 } 
	{ profile_out_ce0 sc_out sc_logic 1 signal 1 } 
	{ profile_out_we0 sc_out sc_logic 1 signal 1 } 
	{ profile_out_d0 sc_out sc_lv 16 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_r_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "in_r", "role": "q1" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "95509", "Max" : "95509"}
	, {"Name" : "Interval", "Min" : "95509", "Max" : "95509"}
]}
...
set Spec2ImplPortList { 
	in_r { ap_memory {  { in_r_address0 mem_address 1 14 }  { in_r_ce0 mem_ce 1 1 }  { in_r_q0 mem_dout 0 16 }  { in_r_address1 MemPortADDR2 1 14 }  { in_r_ce1 MemPortCE2 1 1 }  { in_r_q1 MemPortDOUT2 0 16 } } }
