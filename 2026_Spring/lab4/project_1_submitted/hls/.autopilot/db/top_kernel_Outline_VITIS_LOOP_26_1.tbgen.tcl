set moduleName top_kernel_Outline_VITIS_LOOP_26_1
set isTopModule 0
...
set cdfgNum 11
set C_modelName {top_kernel_Outline_VITIS_LOOP_26_1}
...
set C_modelArgList {
	...
	{ sext_ln26_1 int 62 regular  }
	{ sext_ln26_2 int 62 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in_r","offset": { "type": "dynamic","port_name": "in_r","bundle": "control"},"direction": "READONLY"},{"cName": "in_g","offset": { "type": "dynamic","port_name": "in_g","bundle": "control"},"direction": "READONLY"},{"cName": "in_b","offset": { "type": "dynamic","port_name": "in_b","bundle": "control"},"direction": "READONLY"},{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln26", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln26_1", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln26_2", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln26_1 sc_in sc_lv 62 signal 2 } 
	{ sext_ln26_2 sc_in sc_lv 62 signal 3 } 
	{ intensity_address0 sc_out sc_lv 12 signal 4 } 
	{ intensity_ce0 sc_out sc_logic 1 signal 4 } 
	{ intensity_we0 sc_out sc_logic 1 signal 4 } 
	{ intensity_d0 sc_out sc_lv 32 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln26_1", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln26_1", "role": "default" }} , 
 	{ "name": "sext_ln26_2", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln26_2", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "172161", "Max" : "172161"}
	, {"Name" : "Interval", "Min" : "172161", "Max" : "172161"}
]}
...
set Spec2ImplPortList { 
	...
	sext_ln26_1 { ap_none {  { sext_ln26_1 in_data 0 62 } } }
	sext_ln26_2 { ap_none {  { sext_ln26_2 in_data 0 62 } } }
