set moduleName top_kernel_Pipeline_VITIS_LOOP_193_25_VITIS_LOOP_195_26
set isTopModule 0
...
set cdfgNum 11
set C_modelName {top_kernel_Pipeline_VITIS_LOOP_193_25_VITIS_LOOP_195_26}
...
set C_modelArgList {
	{ bilateral_filtered float 32 regular {array 4096 { 1 1 } 1 1 } {global 0}  }
...
set portList { 
	...
	{ bilateral_filtered_address0 sc_out sc_lv 12 signal 0 } 
	{ bilateral_filtered_ce0 sc_out sc_logic 1 signal 0 } 
	{ bilateral_filtered_q0 sc_in sc_lv 32 signal 0 } 
	{ bilateral_filtered_address1 sc_out sc_lv 12 signal 0 } 
	{ bilateral_filtered_ce1 sc_out sc_logic 1 signal 0 } 
	{ bilateral_filtered_q1 sc_in sc_lv 32 signal 0 } 
	{ eroded_address0 sc_out sc_lv 12 signal 1 } 
	{ eroded_ce0 sc_out sc_logic 1 signal 1 } 
	{ eroded_we0 sc_out sc_logic 1 signal 1 } 
	{ eroded_d0 sc_out sc_lv 32 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bilateral_filtered_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "bilateral_filtered", "role": "address1" }} , 
 	{ "name": "bilateral_filtered_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "bilateral_filtered", "role": "ce1" }} , 
 	{ "name": "bilateral_filtered_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bilateral_filtered", "role": "q1" }} , 
...
set Spec2ImplPortList { 
	bilateral_filtered { ap_memory {  { bilateral_filtered_address0 mem_address 1 12 }  { bilateral_filtered_ce0 mem_ce 1 1 }  { bilateral_filtered_q0 mem_dout 0 32 }  { bilateral_filtered_address1 MemPortADDR2 1 12 }  { bilateral_filtered_ce1 MemPortCE2 1 1 }  { bilateral_filtered_q1 MemPortDOUT2 0 32 } } }
