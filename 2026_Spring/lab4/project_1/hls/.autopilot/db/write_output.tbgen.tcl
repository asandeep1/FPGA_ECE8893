...
set C_modelArgList {
	{ morphology_stream int 12 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "morphology_stream", "interface" : "fifo", "bitwidth" : 12, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ morphology_stream_dout sc_in sc_lv 12 signal 0 } 
	{ morphology_stream_empty_n sc_in sc_logic 1 signal 0 } 
	{ morphology_stream_read sc_out sc_logic 1 signal 0 } 
	{ morphology_stream_num_data_valid sc_in sc_lv 9 signal 0 } 
	{ morphology_stream_fifo_cap sc_in sc_lv 9 signal 0 } 
	{ out_r_dout sc_in sc_lv 64 signal 2 } 
	{ out_r_empty_n sc_in sc_logic 1 signal 2 } 
	{ out_r_read sc_out sc_logic 1 signal 2 } 
	{ out_r_num_data_valid sc_in sc_lv 4 signal 2 } 
	{ out_r_fifo_cap sc_in sc_lv 4 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "morphology_stream_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "morphology_stream", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	morphology_stream { ap_fifo {  { morphology_stream_dout fifo_data_in 0 12 }  { morphology_stream_empty_n fifo_status 0 1 }  { morphology_stream_read fifo_port_we 1 1 }  { morphology_stream_num_data_valid fifo_status_num_data_valid 0 9 }  { morphology_stream_fifo_cap fifo_update 0 9 } } }
