set moduleName Loop_VITIS_LOOP_393_1_proc
set isTopModule 0
...
set cdfgNum 20
set C_modelName {Loop_VITIS_LOOP_393_1_proc}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ out_r int 64 regular {fifo 0}  }
	{ gmem3 int 32 regular {axi_master 1}  }
	{ morphology_stream int 14 regular {fifo 0 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "out_r", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "morphology_stream", "interface" : "fifo", "bitwidth" : 14, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ morphology_stream_dout sc_in sc_lv 14 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "morphology_stream_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "morphology_stream", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	...
	morphology_stream { ap_fifo {  { morphology_stream_dout fifo_data_in 0 14 }  { morphology_stream_empty_n fifo_status 0 1 }  { morphology_stream_read fifo_port_we 1 1 }  { morphology_stream_num_data_valid fifo_status_num_data_valid 0 9 }  { morphology_stream_fifo_cap fifo_update 0 9 } } }
}
