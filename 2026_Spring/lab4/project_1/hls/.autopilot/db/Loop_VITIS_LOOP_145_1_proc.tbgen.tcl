set moduleName Loop_VITIS_LOOP_145_1_proc
set isTopModule 0
...
set cdfgNum 12
set C_modelName {Loop_VITIS_LOOP_145_1_proc}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ in_r int 64 regular  }
	{ gmem0 int 16 regular {axi_master 0}  }
	{ in_stream int 16 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "in_r", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "in_stream", "interface" : "fifo", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ in_stream_din sc_out sc_lv 16 signal 2 } 
	{ in_stream_full_n sc_in sc_logic 1 signal 2 } 
	{ in_stream_write sc_out sc_logic 1 signal 2 } 
	{ in_stream_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ in_stream_fifo_cap sc_in sc_lv 3 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_stream_din", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "in_stream", "role": "din" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "49160", "Max" : "49160"}
	, {"Name" : "Interval", "Min" : "49160", "Max" : "49160"}
]}
...
set Spec2ImplPortList { 
	...
	in_stream { ap_fifo {  { in_stream_din fifo_data_in 1 16 }  { in_stream_full_n fifo_status 0 1 }  { in_stream_write fifo_port_we 1 1 }  { in_stream_num_data_valid fifo_status_num_data_valid 0 3 }  { in_stream_fifo_cap fifo_update 0 3 } } }
}
