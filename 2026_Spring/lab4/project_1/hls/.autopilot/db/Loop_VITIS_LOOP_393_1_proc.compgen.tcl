...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { morphology_stream_dout { I 14 vector } morphology_stream_empty_n { I 1 bit } morphology_stream_read { O 1 bit } morphology_stream_num_data_valid { I 9 vector } morphology_stream_fifo_cap { I 9 vector } } \
} "
}
