...
module sv_module_top;
    ...
    axi_if #(64,4,8,3,1)  axi_gmem3_if (.clk  (apatb_top_kernel_top.AESL_clock), .rst(apatb_top_kernel_top.AESL_reset));
    assign axi_gmem3_if.AWVALID = apatb_top_kernel_top.gmem3_AWVALID;
    assign apatb_top_kernel_top.gmem3_AWREADY = axi_gmem3_if.AWREADY;
    assign axi_gmem3_if.AWADDR = apatb_top_kernel_top.gmem3_AWADDR;
    assign axi_gmem3_if.AWID = apatb_top_kernel_top.gmem3_AWID;
    assign axi_gmem3_if.AWLEN = apatb_top_kernel_top.gmem3_AWLEN;
    assign axi_gmem3_if.AWSIZE = apatb_top_kernel_top.gmem3_AWSIZE;
    assign axi_gmem3_if.AWBURST = apatb_top_kernel_top.gmem3_AWBURST;
    assign axi_gmem3_if.AWLOCK = apatb_top_kernel_top.gmem3_AWLOCK;
    assign axi_gmem3_if.AWCACHE = apatb_top_kernel_top.gmem3_AWCACHE;
    assign axi_gmem3_if.AWPROT = apatb_top_kernel_top.gmem3_AWPROT;
    assign axi_gmem3_if.AWQOS = apatb_top_kernel_top.gmem3_AWQOS;
    assign axi_gmem3_if.AWREGION = apatb_top_kernel_top.gmem3_AWREGION;
    assign axi_gmem3_if.AWUSER = apatb_top_kernel_top.gmem3_AWUSER;
    assign axi_gmem3_if.WVALID = apatb_top_kernel_top.gmem3_WVALID;
    assign apatb_top_kernel_top.gmem3_WREADY = axi_gmem3_if.WREADY;
    assign axi_gmem3_if.WDATA = apatb_top_kernel_top.gmem3_WDATA;
    assign axi_gmem3_if.WSTRB = apatb_top_kernel_top.gmem3_WSTRB;
    assign axi_gmem3_if.WLAST = apatb_top_kernel_top.gmem3_WLAST;
    assign axi_gmem3_if.WID = apatb_top_kernel_top.gmem3_WID;
    assign axi_gmem3_if.WUSER = apatb_top_kernel_top.gmem3_WUSER;
    assign axi_gmem3_if.ARVALID = apatb_top_kernel_top.gmem3_ARVALID;
    assign apatb_top_kernel_top.gmem3_ARREADY = axi_gmem3_if.ARREADY;
    assign axi_gmem3_if.ARADDR = apatb_top_kernel_top.gmem3_ARADDR;
    assign axi_gmem3_if.ARID = apatb_top_kernel_top.gmem3_ARID;
    assign axi_gmem3_if.ARLEN = apatb_top_kernel_top.gmem3_ARLEN;
    assign axi_gmem3_if.ARSIZE = apatb_top_kernel_top.gmem3_ARSIZE;
    assign axi_gmem3_if.ARBURST = apatb_top_kernel_top.gmem3_ARBURST;
    assign axi_gmem3_if.ARLOCK = apatb_top_kernel_top.gmem3_ARLOCK;
    assign axi_gmem3_if.ARCACHE = apatb_top_kernel_top.gmem3_ARCACHE;
    assign axi_gmem3_if.ARPROT = apatb_top_kernel_top.gmem3_ARPROT;
    assign axi_gmem3_if.ARQOS = apatb_top_kernel_top.gmem3_ARQOS;
    assign axi_gmem3_if.ARREGION = apatb_top_kernel_top.gmem3_ARREGION;
    assign axi_gmem3_if.ARUSER = apatb_top_kernel_top.gmem3_ARUSER;
    assign apatb_top_kernel_top.gmem3_RVALID = axi_gmem3_if.RVALID;
    assign axi_gmem3_if.RREADY = apatb_top_kernel_top.gmem3_RREADY;
    assign apatb_top_kernel_top.gmem3_RDATA = axi_gmem3_if.RDATA;
    assign apatb_top_kernel_top.gmem3_RLAST = axi_gmem3_if.RLAST;
    assign apatb_top_kernel_top.gmem3_RID = axi_gmem3_if.RID;
    assign apatb_top_kernel_top.gmem3_RUSER = axi_gmem3_if.RUSER;
    assign apatb_top_kernel_top.gmem3_RRESP = axi_gmem3_if.RRESP;
    assign apatb_top_kernel_top.gmem3_BVALID = axi_gmem3_if.BVALID;
    assign axi_gmem3_if.BREADY = apatb_top_kernel_top.gmem3_BREADY;
    assign apatb_top_kernel_top.gmem3_BRESP = axi_gmem3_if.BRESP;
    assign apatb_top_kernel_top.gmem3_BID = axi_gmem3_if.BID;
    assign apatb_top_kernel_top.gmem3_BUSER = axi_gmem3_if.BUSER;
    initial begin
        uvm_config_db #( virtual axi_if#(64,4,8,3,1) )::set(null, "uvm_test_top.top_env.axi_master_gmem3.*", "vif", axi_gmem3_if);
    end
